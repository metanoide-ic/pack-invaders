...
- ✅ **Checklist de Posts** — acompanhamento de cada publicação da _ideia_ à
  _veiculação_ (etapas: ideia → roteiro → produção → edição → aprovação → agendado →
  publicado), com legenda, observações e checklist de produção.
- 💰 **Financeiro** — receitas, despesas, saldo e "a receber", com gráfico de
  evolução e visão por cliente.
...
- A criação de conta é local e imediata — basta nome, e-mail e senha.
