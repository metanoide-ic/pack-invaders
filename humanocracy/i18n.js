...
const I18N_EN = {
  ...
  'MINISTÉRIO DE TRIAGEM · FOLHA DE PONTO — POSTO Nº 7': 'MINISTRY OF TRIAGE · TIME SHEET — POST Nº 7',
  'REGISTRADO': 'FILED',
  'JOGAR': 'PLAY',
  'RETOMAR': 'RESUME',
  'OPÇÕES': 'OPTIONS',
  ...
  'GAVETA A · EXPEDIENTE': 'DRAWER A · DESK WORK', 'GAVETA B · TRIAGEM': 'DRAWER B · SCREENING',
  'LUPA': 'LOUPE', 'DOSSIÊ': 'DOSSIER',
  'Abrir/fechar a gaveta': 'Open/close the drawer',
  'Carta de fronteiras — arraste até a MESA para abrir': 'Border chart — drag onto the DESK to open',
  'Lupa de inspeção — arraste até os documentos ou o vidro': 'Inspection loupe — drag onto the documents or the glass',
  'Ficha de exame físico — arraste até o cidadão (10 min)': 'Physical exam form — drag onto the citizen (10 min)',
  'Dossiê da vida documentada — arraste até o cidadão (10 min)': 'Documented-life dossier — drag onto the citizen (10 min)',
  'Comunicado oficial do dia — clique para reler': "The day's official notice — click to reread",
  'REVISTAR BAGAGEM': 'SEARCH LUGGAGE',
  /* atentados no guichê */
  'ARMA — ATIRE OU DETENHA': 'WEAPON — SHOOT OR DETAIN',
  'EXPLOSIVOS — DETENHA OU ATIRE': 'EXPLOSIVES — DETAIN OR SHOOT',
  'Pistola de serviço — clique para sacar': 'Service pistol — click to draw',
  'OCORRÊNCIA NO POSTO Nº 7': 'INCIDENT AT POST Nº 7',
  'NEUTRALIZADO NO GUICHÊ': 'NEUTRALIZED AT THE WINDOW',
  'DETIDO ANTES DE AGIR': 'DETAINED BEFORE ACTING',
  'ARQUIVAR': 'FILE IT',
  /* transmissão oficial */
  'TRANSMISSÃO OFICIAL': 'OFFICIAL BROADCAST',
  'DESLIGAR O APARELHO': 'TURN THE SET OFF',
  'PORTA-VOZ DO MINISTÉRIO': 'MINISTRY SPOKESMAN',
  'COMANDO NACIONAL MEHRVOLK': 'MEHRVOLK NATIONAL COMMAND',
  'INSTITUTO DE FENOTIPIA': 'INSTITUTE OF PHENOTYPY',
  'BOLETIM DE EMERGÊNCIA': 'EMERGENCY BULLETIN',
  'CONSELHO POPULAR DE OSTERIA': "OSTERIA'S PEOPLE'S COUNCIL",
  '— SEM IDENTIFICAÇÃO —': '— NO IDENTIFICATION —',
  /* o corredor e o espelho */
  'E — Abrir a porta do banheiro': 'E — Open the bathroom door',
  'PULAR': 'SKIP',
  'Carimbo APROVADO — arraste até um documento e solte': 'APPROVED stamp — drag onto a document and release',
  'Almofada de tinta — encoste o carimbo para entintar': 'Ink pad — press the stamp here to re-ink',
  'Sineta do balcão': 'Counter bell',
  'Carimbo REJEITADO — arraste até um documento e solte': 'REJECTED stamp — drag onto a document and release',
  'Lupa de exame — arraste até o cidadão (10 min); a bagagem se revista por ela': 'Exam loupe — drag onto the citizen (10 min); luggage is searched through it',
  ...
  /* ---- casa ---- */
  'WASD/setas andar · mova o mouse p/ olhar · E interagir':
    'WASD/arrows to walk · move the mouse to look · E to interact',
  ...
  'FINAL — O CARIMBO CONHECIDO': 'ENDING — THE FAMILIAR STAMP',
  'O relógio da sala marca 20h31 quando você percebe que está de pé, atravessando o próprio corredor, como se já tivesse feito isso a vida inteira — o que, no fundo, é quase verdade.\n\nDo outro lado do vidro alguém desliza documentos pela bandeja. Nome, foto, 48 assinaturas de turno, nenhuma perfeitamente igual à anterior. Ninguém nunca reparou nisso. Você também não reparava, nos outros.\n\nA mão pega o carimbo antes de você decidir pegar. É um músculo que já sabe o movimento, treinado por 47 repetições.\n\nAPROVADO. A tinta seca depressa, como sempre secou. Do outro lado, alguém com o seu rosto guarda os papéis, levanta, sai andando — talvez para uma vida que é a sua. Você continua sentado mais um instante. Não é dúvida. É só o corpo, ainda tentando lembrar qual dos dois ficou com o lugar de verdade.':
    "The clock in the room reads 8:31 PM when you notice you're on your feet, crossing your own hallway, as if you'd done this your whole life — which, deep down, is almost true.\n\nOn the other side of the glass someone slides documents across the tray. Name, photo, 48 shift signatures, none of them perfectly matching the last. No one ever noticed. You never noticed it in others either.\n\nThe hand picks up the stamp before you decide to. It's a muscle that already knows the movement, trained by 47 repetitions.\n\nAPPROVED. The ink dries fast, the way it always dried. On the other side, someone with your face gathers the papers, stands, walks off — maybe toward a life that's yours. You stay seated a moment longer. It isn't doubt. It's just the body, still trying to remember which of the two ended up with the real place.",

  'FINAL — O CARIMBO NÃO HESITOU': "ENDING — THE STAMP DIDN'T HESITATE",
  'A mão sobe e desce antes mesmo de você acabar de reconhecer o próprio rosto do outro lado do vidro. Rápido. Seco. Como sempre foi.\n\nO problema é a memória, que chega um segundo atrasada: várias pessoas inocentes saíram do seu guichê algemadas porque duvidar de menos era mais rápido do que duvidar direito. Você chamou isso de rigor, na época. De fazer o trabalho como manda o regulamento.\n\nO reflexo não reclama do carimbo. Por que reclamaria? Ele é você, e você nunca precisou de muito para se convencer de nada.\n\nAPROVADO. A tinta seca. Do outro lado, alguém com sua cara junta os papéis e sai andando, leve, como se nada ali tivesse pesado — porque, para ele, nunca pesou o bastante.':
    "The hand rises and falls before the rest of you finishes recognizing your own face on the other side of the glass. Fast. Dry. The way it always was.\n\nThe trouble is memory, which arrives a second late: several innocent people left your window in handcuffs because doubting less was faster than doubting properly. You called that rigor, back then. Doing the job the way the rulebook says.\n\nThe reflection doesn't complain about the stamp. Why would it? It's you, and you never needed much to convince yourself of anything.\n\nAPPROVED. The ink dries. On the other side, someone with your face gathers the papers and walks off, light, as if none of it had weighed anything — because, for him, it never weighed enough.",

  'FINAL — O PREÇO DO PRÓPRIO CARIMBO': 'ENDING — THE PRICE OF YOUR OWN STAMP',
  'Você desliza os documentos pela bandeja e, por hábito, os dedos procuram um envelope que não está lá. É você do outro lado do vidro — subornar a si mesmo seria, no mínimo, redundante.\n\nFoi fácil, lá atrás. Um envelope aqui, outro ali, ninguém contando alto o bastante para alguém notar. O dinheiro pagou remédio, aquecimento, um mês de aluguel adiantado. Também pagou, sem que ninguém assinasse nada, a passagem de algumas pessoas que não deviam passar.\n\nO reflexo espera, com a mesma cara que você faz quando finge que não está fazendo conta.\n\nVocê aprova. Claro que aprova: o seu próprio carimbo, pelo menos esse, sempre esteve à venda para você — de graça.':
    "You slide the documents across the tray and, out of habit, your fingers search for an envelope that isn't there. It's you on the other side of the glass — bribing yourself would be, at minimum, redundant.\n\nIt was easy, back then. An envelope here, another there, no one ever counting loud enough for anyone to notice. The money paid for medicine, heating, a month's rent in advance. It also paid, without anyone signing anything, for the passage of a few people who shouldn't have passed.\n\nThe reflection waits, wearing the same face you make when you pretend you're not doing the math.\n\nYou approve. Of course you approve: your own stamp, at least, has always been for sale to you — free of charge.",

  'FINAL — O PORTÃO DE FERRO': 'ENDING — THE IRON GATE',
  'Rejeitou mais do que aprovou. Em algum dia que você não sabe apontar, rejeitar virou o padrão — e aprovar, a exceção que precisava se explicar.\n\nHá gente na fronteira de Osteria, hoje, que nunca vai saber por que deu meia-volta: uma vírgula fora do lugar, um selo meio desbotado, um segundo de dúvida que você preferiu não arriscar. Algumas dessas pessoas, você sabe, não tinham para onde voltar.\n\nO reflexo é implacável do mesmo jeito. Você reconhece o gesto assim que ele começa — o carimbo vermelho decidido antes mesmo de terminar de ler — e aprova a si mesmo sem pestanejar. É a única coisa em você que nunca vacila: o próprio rigor.\n\nO portão fica fechado para quase todo mundo. Para você, sempre esteve escancarado.':
    "Rejected more than you approved. On some day you can't quite point to, rejecting became the default — and approving, the exception that had to explain itself.\n\nThere are people at Osteria's border, today, who will never know why they turned back: a comma out of place, a slightly faded seal, a second of doubt you chose not to risk. Some of them, you know, had nowhere to turn back to.\n\nThe reflection is just as implacable. You recognize the gesture the moment it starts — the red stamp decided before it even finishes reading — and approve yourself without blinking. It's the one thing in you that never wavers: your own severity.\n\nThe gate stays closed for almost everyone. For you, it was always wide open.",

  'FINAL — A MÃO QUE NÃO TREMEU DO JEITO ERRADO': "ENDING — THE HAND THAT DIDN'T SHAKE THE WRONG WAY",
  'Nenhum inocente saiu do seu guichê algemado. Nem um, em 48 dias. Não é o tipo de número que sai em boletim do Ministério — mas você sabe, e é seu.\n\nAjudou quem deu para ajudar, quando havia como ajudar sem que ninguém visse: um bilhete guardado em vez de queimado, um nome que você não perguntou de novo na segunda vez que apareceu.\n\nO reflexo se aprova, e pela primeira vez em 48 dias isso não soa como um gesto vazio. Soa quase como algo que se ganhou.\n\nVocê não salvou o país. Não salvou nem o posto. Salvou umas poucas pessoas específicas, com nome — de quem nunca soube dizer se eram humanas — e decidiu que a pergunta importava menos do que a resposta que deu.':
    "No innocent left your window in handcuffs. Not one, in 48 days. It's not the kind of number that shows up in a Ministry bulletin — but you know it, and it's yours.\n\nYou helped who you could, when there was a way to help without anyone seeing: a note kept instead of burned, a name you didn't ask about again the second time it came up.\n\nThe reflection approves itself, and for the first time in 48 days it doesn't sound like an empty gesture. It sounds almost like something earned.\n\nYou didn't save the country. Didn't even save the post. You saved a few specific people, with names — people you never knew for certain were human — and decided the question mattered less than the answer you gave.",

  'FINAL — A MÁQUINA PERFEITA': 'ENDING — THE PERFECT MACHINE',
  'Zero erros no registro. Trinta e cinco decisões corretas, talvez mais — o número exato já nem importa: passado certo ponto, "perfeito" para de ser contável e vira só um jeito de ser.\n\nNos últimos dias os colegas param de te chamar pelo nome. Dizem "o modelo", baixinho, meio elogio, meio aviso. Ninguém acerta 48 dias seguidos continuando humano o tempo inteiro.\n\nO reflexo aprova e a mão não treme — nunca tremeu, nem uma vez, mesmo nas vezes em que devia.\n\nVocê sai do posto sem uma marca sequer no registro. Já não sabe se isso prova que fez tudo certo ou só que faz tempo que parou de sentir a diferença.':
    'Zero errors on record. Thirty-five correct decisions, maybe more — the exact number doesn\'t matter anymore: past a certain point, "perfect" stops being countable and just becomes a way of being.\n\nIn these last few days your colleagues stop calling you by name. They say "the model," quietly, half compliment, half warning. No one gets 48 days right in a row while staying human the whole time.\n\nThe reflection approves and the hand doesn\'t shake — never shook, not once, even the times it should have.\n\nYou leave the post without a single mark on your record. You no longer know if that proves you did everything right, or just that you stopped feeling the difference a long time ago.',

  'FINAL — A MESA COM UM LUGAR A MENOS': 'ENDING — THE TABLE WITH ONE PLACE MISSING',
  'A casa não ficou vazia. Ficou incompleta — o que, de um jeito estranho, dói mais: a rotina segue, o jantar é servido, só que sempre falta um prato na pilha que ninguém guarda.\n\nQuem ficou não fala do assunto. Fala ao redor dele, com um cuidado que vocês nunca precisaram ter uns com os outros antes.\n\nVocê carimbou papel por 48 dias tentando decidir quem entra e quem fica de fora. Não conseguiu decidir a única coisa que de fato importava: quem, na sua própria casa, sobrevive ao inverno.\n\nO posto reabre amanhã, com ou sem você. A mesa em casa, também.':
    "The house didn't end up empty. It ended up incomplete — which, in some strange way, hurts more: the routine goes on, dinner gets served, just always one plate short of the stack no one puts away.\n\nThe ones who stayed don't talk about it. They talk around it, with a care none of you ever needed with each other before.\n\nYou stamped paper for 48 days trying to decide who gets in and who's left out. You never managed to decide the one thing that actually mattered: who, in your own house, survives the winter.\n\nThe post reopens tomorrow, with or without you. So does the table at home.",

  'FINAL — O CORREDOR VAZIO': 'ENDING — THE EMPTY HALLWAY',
  'No dia 48, o corredor do Bloco 14 ainda tem sete portas. Uma delas nunca mais abriu.\n\nVocê tentou não contar os dias. Contou de qualquer jeito: três, entre a menção e os móveis saindo de manhã. Ninguém no prédio pergunta pelo apartamento vazio — perguntar virou o tipo de coisa que move as pessoas para uma porta diferente da sua.\n\nO sargento disse "excelente memória, inspetor" e nunca mais precisou de outra. Você forneceu uma vez. Isso basta para sempre ser, no fichário de alguém, a pessoa que fornece.\n\nOs quarenta e oito dias terminam. O corredor continua com sete portas. Você aprende a olhar só para a sua.':
    'On day 48, the hallway at Block 14 still has seven doors. One of them never opened again.\n\nYou tried not to count the days. You counted anyway: three, between the mention and the furniture going out in the morning. No one in the building asks about the empty apartment — asking has become the kind of thing that moves people to a different door than yours.\n\nThe sergeant said "excellent memory, inspector" and never needed to ask you again. You provided once. That\'s enough to always be, in someone\'s file, the person who provides.\n\nThe forty-eight days end. The hallway still has seven doors. You learn to look only at your own.',

  'FINAL — O ENVELOPE VIROU ROTINA': 'ENDING — THE ENVELOPE BECAME ROUTINE',
  'Ninguém mais desliza um envelope escondido. Nos últimos dias, colocam em cima da pilha de documentos, junto com o passaporte, como mais um papel a carimbar.\n\nVocê perdeu a conta em algum lugar entre o terceiro e o sétimo. Não perdeu o hábito de contar o dinheiro depois, no banheiro do posto, com a porta trancada.\n\nOs colegas sabem. O supervisor sabe, e o supervisor também sabe quanto custa saber e ficar calado. É o tipo de aritmética que o Ministério nunca ensina, mas que todo mundo aprende sozinho até o dia 20.\n\nNo dia 48, o guichê fecha como sempre fechou: no horário, sem escândalo. Você sai com mais dinheiro do que qualquer salário jamais te daria, e menos certeza do que aprovou de verdade do que qualquer inspetor deveria ter.':
    "No one slides a hidden envelope anymore. In the last few days, they just set it on top of the documents, next to the passport, like one more paper to stamp.\n\nYou lost count somewhere between the third and the seventh. You never lost the habit of counting the money afterward, in the post's bathroom, with the door locked.\n\nYour colleagues know. The supervisor knows, and the supervisor also knows what it costs to know and stay quiet. It's the kind of arithmetic the Ministry never teaches, but everyone learns on their own by day 20.\n\nOn day 48, the window closes the way it always closed: on time, no scandal. You leave with more money than any salary would ever give you, and less certainty about what you actually approved than any inspector should have.",

  'FINAL — A PONTARIA ERRADA': 'ENDING — THE WRONG AIM',
  'O relatório do Ministério não sabe o que você fez de verdade. Sabe os números, e números não perdoam.\n\nGente inocente passou pelo seu guichê e saiu detida. Alternados, na mesma semana, passaram pelo mesmo guichê e saíram livres, sem que você suspeitasse de nada.\n\nNão existe uma palavra oficial para isso. Você inventou uma sozinho, numa madrugada sem sono: errar para os dois lados ao mesmo tempo. Bateu na porta errada da paranoia e na porta errada do descuido, na mesma semana, com o mesmo carimbo.\n\nDia 48. Continua sem saber se prendeu gente demais ou gente de menos. As duas coisas são verdade ao mesmo tempo — e isso, só isso, você tem certeza.':
    "The Ministry's report doesn't know what you actually did. It knows the numbers, and numbers don't forgive.\n\nInnocent people passed through your window and left detained. Alternates, the same week, passed through the same window and left free, without you suspecting a thing.\n\nThere's no official word for that. You invented one, alone, on a sleepless night: erring in both directions at once. You hit the wrong door of paranoia and the wrong door of carelessness, in the same week, with the same stamp.\n\nDay 48. You still don't know whether you detained too many people or too few. Both are true at once — and that, only that, you're sure of.",

  'FINAL — A MIRA CERTA': 'ENDING — DEAD AIM',
  'Oito. O número fica repetindo na sua cabeça mesmo depois que você para de contar: oito Alternados identificados, detidos, removidos do fluxo — e nenhum inocente arrastado junto no caminho.\n\nOs colegas comentam baixo, quase respeito, quase medo: você tem "faro". Ninguém usa a palavra certa, porque a palavra certa implicaria que você sabe algo que o Ministério não ensina em nenhum manual.\n\nTalvez seja mesmo faro. Talvez seja sorte disfarçada de método, oito vezes seguidas. Talvez os oito só fossem particularmente descuidados, e o próximo — o que você não vai pegar — seja bom demais para o olho que você sempre teve.\n\nNo dia 48, o Ministério manda uma carta de reconhecimento formal e um convite para "consultoria de treinamento". Você não sabe se aceita. Sabe, com uma certeza fria que não devia ter, que vai continuar olhando as pessoas do jeito que aprendeu a olhar, pelo resto da vida, dentro ou fora do posto.':
    'Eight. The number keeps repeating in your head even after you stop counting: eight Alternates identified, detained, pulled out of the flow — with no innocent dragged along in the process.\n\nYour colleagues mention it quietly, half respect, half fear: you have a "nose" for it. No one uses the right word, because the right word would imply you know something the Ministry doesn\'t teach in any manual.\n\nMaybe it really is instinct. Maybe it\'s luck dressed up as method, eight times in a row. Maybe the eight were just particularly careless, and the next one — the one you won\'t catch — is too good for the eye you\'ve always had.\n\nOn day 48, the Ministry sends a formal letter of recognition and an invitation to "training consultancy." You don\'t know if you\'ll accept. You know, with a cold certainty you shouldn\'t have, that you\'ll keep looking at people the way you learned to look at them, for the rest of your life, inside or outside the post.',
  ...
  'Espelhos usados pela metade do preço. Não perguntamos por que você não quer mais o seu.': "Used mirrors, half price. We don't ask why you no longer want yours.",
  'Repintamos o retrato da sua família enquanto você espera. Fica igualzinho. Igualzinho.': 'We repaint your family portrait while you wait. Comes out just the same. Just the same.',
  'Curso noturno: reconheça a própria letra em três lições. Certificado oficial.': 'Night course: recognize your own handwriting in three lessons. Official certificate.',
  'Aluga-se quarto sem janelas. "Mais seguro assim", diz o senhorio, sorrindo.': 'Room for rent, no windows. "Safer this way," says the landlord, smiling.',
  ...
  'Tomi voltou da escola com a cartilha nova e pediu para ver as suas mãos. Olhou com cuidado, contou os calos e disse: "Passou." Depois riu, porque para ele era um jogo. Vessa não riu. Você também não conseguiu.':
    'Tomi came home from school with the new primer and asked to see your hands. He looked carefully, counted the calluses, and said: "Passed." Then he laughed, because to him it was a game. Vessa didn\'t laugh. Neither could you.',
  ...
  'Trocaram o retrato da parede do saguão pela terceira vez em dois meses. O prego é o mesmo, o buraco é o mesmo, só o rosto muda. Sua mãe passou por ele sem olhar e comentou: "Aquele prego já viu mais governo do que eu."':
    'They swapped the portrait on the lobby wall for the third time in two months. The nail is the same, the hole is the same, only the face changes. Your mother walked past it without looking and remarked: "That nail has outlived more governments than I have."',
  'Dario chegou tarde e com terra no casaco. Disse que ajudou a carregar caixas na estação. Não há mais trens na estação desde o dia 27. Você não perguntou de novo — e passou a noite calculando há quanto tempo o seu filho aprendeu a mentir para te proteger.':
    'Dario came home late with dirt on his coat. He said he helped carry boxes at the station. There have been no trains at the station since day 27. You didn\'t ask again — and spent the night calculating how long your son had known how to lie to protect you.',
  ...
  'Não durmo direito desde o último comunicado.': "I haven't slept right since the last bulletin.",
  'O senhor tem um rosto fácil de esquecer. No meu ofício, isso é elogio.': "You have a face that's easy to forget. In my trade, that's a compliment.",
  'Meu pai dizia: fila boa é fila que anda. Esta anda?': 'My father used to say: a good line is a line that moves. Does this one move?',
  'Prometo que não vou dar trabalho. Todo mundo promete, eu sei.': "I promise I won't be any trouble. Everyone promises that, I know.",
  'O jornal de hoje diz que melhorou. O de ontem também dizia.': "Today's paper says it's gotten better. Yesterday's said so too.",
  'Eu tenho os documentos certos. Eu SOU a pessoa certa. Não sou?': "I have the right documents. I AM the right person. Aren't I?",
  'Reparti meu pão com o da frente na fila. Ele não comeu. Só olhou.': "I shared my bread with the one ahead of me in line. He didn't eat. He just watched.",
  'Ouvi que amanhã não abre. Ouvi que nunca mais abre.': "I heard it doesn't open tomorrow. I heard it never opens again.",
  ...
  /* ---- ACOMPANHANTES (pais com bebê/criança no guichê) ---- */
  'Ela dormiu agora. Por favor… fale baixo.': 'She just fell asleep. Please… keep your voice down.',
  'Nasceu na estrada. Não tem documento ainda. Ninguém me disse que precisava.': "Born on the road. No documents yet. No one told me it needed any.",
  'Ele não chorou uma vez a viagem inteira. Bom menino.': "He didn't cry once the whole trip. Good boy.",
  'Só quero que ela cresça do outro lado. Só isso.': 'I just want her to grow up on the other side. That\'s all.',
  'O leite secou faz dois dias. Ela ainda não sabe reclamar. Eu sei.': "The milk dried up two days ago. She doesn't know to complain yet. I do.",
  'É o único documento que eu tenho dele: sei o peso dele de cor.': 'It\'s the only document I have of him: I know his weight by heart.',
  'Se precisar carimbar, carimbe rápido. Ela acorda com barulho de metal.': 'If you must stamp it, stamp it fast. She wakes at the sound of metal.',
  'Diz "bom dia" pro moço. — …ele é tímido.': 'Say "good morning" to the man. — …he\'s shy.',
  'Ela não solta a minha mão desde que saímos de casa.': "She hasn't let go of my hand since we left home.",
  'Meu filho. Os papéis dele estão junto dos meus. Estão, sim.': 'My son. His papers are with mine. They are, yes.',
  'Não olhe assim pra ela. Ela não fez nada. Nenhum de nós fez.': "Don't look at her like that. She did nothing. None of us did.",
  'Ele decorou o próprio nome e o meu. Caso perguntem. Caso a gente se perca.': 'He memorized his own name and mine. In case they ask. In case we get separated.',
  'Ela perguntou se do outro lado também tem inverno. Não soube mentir.': "She asked if the other side has winter too. I couldn't lie.",
  'Não trouxe brinquedo. Trouxe os documentos dele no lugar. Ele entende — crianças entendem cedo demais aqui.': "I didn't bring a toy. I brought his documents instead. He understands — children understand too early here.",

  /* ---- PISTAS (o que o cidadão suspeito deixa escapar) ---- */
  'Está tudo em ordem. Não precisa conferir cada carimbo, precisa?': "It's all in order. You don't need to check every stamp, do you?",
  'Os documentos são novos. Bem novos. É que os antigos… se perderam.': 'The documents are new. Quite new. It\'s just that the old ones… got lost.',
  'O senhor vai reparar que a data está boa. Está boa, sim.': "You'll notice the date is fine. It's fine, yes.",
  'Não menti em nada. Bom — nada que o senhor precise anotar.': "I didn't lie about anything. Well — nothing you'd need to write down.",
  'Se olhar rápido, está perfeito. É só não olhar devagar.': "If you look quickly, it's perfect. Just don't look slowly.",
  'Eu lembro de nascer lá. Lembro de tudo. Lembro até do que não vi.': "I remember being born there. I remember everything. I even remember what I didn't see.",
  'Estou bem. Estou muito bem. O senhor também está bem. Todos estamos bem.': "I'm fine. I'm very fine. You're fine too. We're all fine.",
  'Não precisa me examinar. Eu sei o que procura. Não está em mim.': "No need to examine me. I know what you're looking for. It's not in me.",
  'Sorrio porque é o correto sorrir. Está correto, o sorriso?': 'I smile because smiling is correct. Is it correct, the smile?',
  'O frio não me incomoda. Nada me incomoda. É mais prático assim.': "The cold doesn't bother me. Nothing bothers me. It's more practical this way.",
  'Pisco quando lembro de piscar. Acabei de lembrar.': 'I blink when I remember to blink. I just remembered.',
  'Por favor, não me barre. Minha filha está do outro lado há três dias.': "Please don't turn me back. My daughter has been on the other side for three days.",
  'Sei que pareço nervoso. Todo mundo parece, aqui. O senhor não parece?': "I know I look nervous. Everyone does here. Don't you?",
  'As mãos tremem, mas é o frio. Juro que é só o frio.': "My hands are shaking, but it's the cold. I swear it's only the cold.",
  'A voz? É rouca do frio da estrada. Sempre foi assim.': "The voice? It's hoarse from the cold of the road. It's always been like this.",
  'Não repare no casaco largo. Aperta menos, viaja melhor.': "Don't mind the loose coat. Less snug, better for traveling.",
  'O nome no passaporte é meu. É meu há tempo suficiente.': "The name on the passport is mine. It's been mine long enough.",
  'Deixe o cachecol onde está. O pescoço é sensível ao vento.': "Leave the scarf where it is. The neck is sensitive to the wind.",

  /* ---- ENCONTROS: falas roteirizadas que faltavam ---- */
  'Essas caixas? Sabonete. Só sabonete importado. Por que pergunta com essa cara, inspetor? Eu tenho uma cara que faz as pessoas perguntarem, é isso, não é? Já ouvi isso antes.': "These boxes? Soap. Just imported soap. Why do you ask with that face, inspector? I have a face that makes people ask, is that it? I've heard that before.",
  'Meu marido morreu na estrada, tentando atravessar sem os papéis certos. Eu vim buscar o corpo com os papéis certos. A ironia não escapou a ninguém na minha família, inspetor. Só a ele.': "My husband died on the road, trying to cross without the right papers. I came to collect the body with the right papers. The irony was lost on no one in my family, inspector. Only on him.",
  'Um dia, inspetor! UM dia! O carimbo diz dia 9, hoje é dia 10, isso é o quê, quatro por cento de atraso? Eu aceito multa. Eu aceito qualquer coisa. Só não me manda de volta pra explicar as caixas de novo.': "One day, inspector! ONE day! The stamp says the 9th, today is the 10th, what's that, four percent late? I'll take the fine. I'll take anything. Just don't send me back to explain the boxes again.",
  'Na Nova República os formulários são digitais e ninguém lê o que a gente escreve mesmo assim. Aqui, pelo menos, o senhor lê. Isso deveria ser reconfortante. Por algum motivo, não é.': "In Nova República the forms are digital and no one reads what we write anyway. Here, at least, you read. That should be reassuring. Somehow, it isn't.",
  'Meu tio mora do outro lado. Eu nunca conheci ele. Minha mãe disse: mostra os papéis, fica quieto, não conta pra ninguém que é a primeira vez que eu viajo sozinho. Ela não sabia que eu ia contar pro senhor.': "My uncle lives across the border. I never met him. My mother said: show the papers, stay quiet, don't tell anyone it's my first time traveling alone. She didn't know I'd tell you.",
  'O comunicado saiu ontem à noite, inspetor. O cartório abre daqui a três horas. Eu trabalho como contadora há dezoito anos nesta cidade. Ontem eu era osteriana. Hoje sou um formulário que ainda não existe.': "The notice went out last night, inspector. The registry opens in three hours. I've worked as an accountant in this city for eighteen years. Yesterday I was Osterian. Today I'm a form that doesn't exist yet.",
  'Levaram meu marido terça-feira. "Sangue Limpo", chamam a operação. Ele vendia pão, inspetor. Eu só quero saber se ele está vivo. O senhor tem acesso a essas listas. Eu vi alguém como o senhor consultando uma, uma vez.': "They took my husband Tuesday. \"Clean Blood,\" they call the operation. He sold bread, inspector. I just want to know if he's alive. You have access to those lists. I saw someone like you consulting one, once.",
  'Na coletiva, quem pergunta demais vira exemplo pros outros. Eu perguntei uma vez de menos e uma vez demais, nessa ordem errada. Aqui eu só quero ser ninguém por um tempo.': "In the collective, whoever asks too much becomes an example for the others. I asked one time too few and one time too many, in that wrong order. Here I just want to be no one for a while.",
  'A Convenção de Alcorte diz que eu tenho direito a atravessar. O senhor também acredita nisso, ou só carimba nisso?': "The Alcorte Convention says I have the right to cross. Do you believe in that too, or do you just stamp on it?",
  'Eu ajudei a calibrar esse scanner que o senhor usa. Marcador K-7. Sabe o que eu descobri, inspetor? Ele detecta ansiedade. Só isso. Eu me demiti. Ninguém me perguntou por quê. Ninguém pergunta essas coisas.': "I helped calibrate that scanner you use. The K-7 marker. Know what I found out, inspector? It detects anxiety. That's all. I quit. No one asked me why. No one asks those things.",
  'Catorze dos meus colegas assinaram aquela carta. Eu não assinei. Vim atravessar mesmo assim, com o passaporte do Andrei — ele não vai precisar mais. Chame isso do que quiser. Eu chamo de covardia com pressa.': "Fourteen of my colleagues signed that letter. I didn't. I came to cross anyway, with Andrei's passport — he won't be needing it anymore. Call it what you want. I call it cowardice in a hurry.",
  'Cem moedas, inspetor. Não é suborno, é… taxa de conveniência. Meu banco quebrou terça-feira. O dinheiro que sobrou é literalmente a única coisa real que ainda tenho. Aceite antes que eu perceba isso também.': "A hundred coins, inspector. It's not a bribe, it's… a convenience fee. My bank collapsed Tuesday. The money that's left is literally the only real thing I have left. Take it before I realize that too.",
  'Meu irmão trabalhava na Estação Central. Trinta e um mortos, disseram. Não disseram nomes. Eu vim ver se o nome dele está numa lista em algum lugar. O senhor tem listas. Todo mundo aqui tem listas.': "My brother worked at Central Station. Thirty-one dead, they said. They didn't say names. I came to see if his name is on a list somewhere. You have lists. Everyone here has lists.",
  'O senhor… mora no Bloco 14, não mora? Nós dividimos o apartamento agora. Minha esposa disse que a sua não fala com a gente. Eu entendo. Eu também não falaria. Só vim pedir a permissão de trabalho. Preciso alimentar minha família — a que veio comigo, e imagino que a sua também.': "You… live in Block 14, don't you? We share the apartment now. My wife says yours won't speak to us. I understand. I wouldn't either. I just came to ask for the work permit. I need to feed my family — the one that came with me, and I imagine yours too.",
  'O regime anterior mentia com carimbos bonitos. O Conselho pelo menos mente honestamente: em papel reciclado, com tinta ruim. Isso é progresso, inspetor. Anote isso. Anote que eu disse isso.': "The previous regime lied with pretty stamps. The Council at least lies honestly: on recycled paper, with bad ink. That's progress, inspector. Write that down. Write down that I said it.",
  'Eu sei o nome da sua esposa. Sei o nome do seu filho, o mais novo. Não é ameaça, inspetor — é currículo. Alguém me paga pra saber esse tipo de coisa sobre gente como o senhor. Achei educado avisar.': "I know your wife's name. I know your son's name, the younger one. It's not a threat, inspector — it's a résumé. Someone pays me to know that kind of thing about people like you. I thought it polite to warn you.",
  'Um nome e um endereço — os seus. Sem assinatura.': 'A name and an address — yours. No signature.',
  'Sou gravadora, inspetor. Carimbos, moldes, chapas — trabalho fino. Esse selo aqui saiu das minhas próprias mãos, e olhe a ironia: nem eu consigo fazer o meu sair perfeito. Ninguém consegue duas vezes seguidas. É por isso que gente como eu ainda tem trabalho.':
    "I'm an engraver, inspector. Stamps, molds, printing plates — fine work. This seal here came out of my own hands, and look at the irony: not even I can make mine come out perfect. No one manages it twice in a row. That's why people like me still have work.",
  'Se um selo não bater, pode ser mão amiga, não inimiga. — S.K.': 'If a seal doesn\'t match, it might be a friendly hand, not a hostile one. — S.K.',
  'Um lote de cartões de identidade "extraviados" reapareceu, dias depois, nas mãos certas. O Ministério abriu inquérito. Não achou nada — o que, dizem, é a marca de um bom trabalho.':
    'A batch of "misplaced" identity cards reappeared, days later, in the right hands. The Ministry opened an inquiry. It found nothing — which, they say, is the mark of good work.',
  'Voltei. Não por mim — me mandaram. Queriam saber se o senhor guardou aquele papel ou queimou. Eu disse que não sabia. Foi a única mentira que contei essa semana, o que já é uma boa semana pra mim.': "I came back. Not for me — they sent me. They wanted to know if you kept that paper or burned it. I said I didn't know. It was the only lie I told this week, which already makes it a good week for me.",
  'Minha irmã disse que um inspetor foi decente com ela, uma vez. Não sei se foi o senhor. Ela também não tinha certeza — disse que os rostos daqui começaram a se confundir pra ela. De qualquer forma: se um dia precisar atravessar sem fila, existe uma rota pelo norte agora que não tem mais fronteira nenhuma vigiando. Ninguém governa lá. É a coisa mais parecida com liberdade que sobrou.': "My sister said an inspector was decent to her, once. I don't know if it was you. She wasn't sure either — she said the faces here started to blur for her. Anyway: if you ever need to cross without a line, there's a route through the north now with no border watching it at all. No one governs there. It's the closest thing to freedom that's left.",
  'Rota do norte: sem posto, sem guarda, sem mapa depois daqui. — M.D.': 'NORTHERN ROUTE: no post, no guard, no map past this point. — M.D.',
  'Posto Nº 4, sabe onde fica? Fechou semana passada. Levaram o meu antecessor primeiro, depois o Ministério, depois a fila toda de gente que ele tinha aprovado "rápido demais". Eu era bom no meu trabalho, inspetor. Isso não significou nada no fim.': "Post No. 4, know where it is? It closed last week. They took my predecessor first, then the Ministry, then the whole line of people he'd approved \"too quickly.\" I was good at my job, inspector. It meant nothing in the end.",
  'No Vale a gente parou de perguntar. Alternado, humano, o que for — planta a mesma terra, cava o mesmo poço. Funciona. Não sei se é coragem ou cansaço. Ninguém no Vale sabe também. E olha, ainda estamos todos vivos, o que é mais do que muita gente sensata pode dizer.': "In the Valley we stopped asking. Altered, human, whatever — plants the same soil, digs the same well. It works. I don't know if it's courage or exhaustion. No one in the Valley knows either. And look, we're all still alive, which is more than a lot of sensible people can say.",

  /* ---- EXAME / LAUDO / COMUNICADO / MAPA / CONTRATO (faltavam) ---- */
  'O acompanhante não é uma criança. As pupilas são fendas; os olhos não têm fundo; não pisca. O adulto aperta-o mais forte quando você olha.': "The companion is not a child. The pupils are slits; the eyes have no depth; it doesn't blink. The adult holds it tighter when you look.",
  'DISCREPÂNCIA DETECTADA — anotada no laudo. Detenção autorizada.': 'DISCREPANCY DETECTED — noted in the report. Detention authorized.',
  'Volume denso oculto sob o casaco — algo que não consta na declaração. Reviste a bagagem.': 'A dense mass hidden under the coat — something not listed in the declaration. Search the baggage.',
  'Nada oculto sob as roupas. Só um corpo com frio.': 'Nothing hidden under the clothes. Just a body, cold.',
  'Biotipo corporal não confere: ombros, quadril e densidade óssea indicam sexo': "Body type doesn't match: shoulders, hips and bone density indicate sex",
  'O passaporte declara': 'The passport declares',
  'Assinatura térmica fraca demais. Este corpo está frio para estar vivo.': 'Thermal signature far too weak. This body is too cold to be alive.',
  '.\n\nAplique o regulamento em vigor (painel à direita). Discrepâncias devem ser confirmadas via INSPEÇÃO antes de justificar detenção.': '.\n\nApply the regulations in force (panel on the right). Discrepancies must be confirmed via INSPECTION before justifying detention.',
  '\n\n★ PROCURADO(A) HOJE: ': '\n\n★ WANTED TODAY: ',
  '\n\n§ COTA DE ADMISSÃO DE HOJE: ': "\n\n§ TODAY'S ADMISSION QUOTA: ",
  '\n\n§ REAJUSTE PATRIÓTICO: ': '\n\n§ PATRIOTIC ADJUSTMENT: ',
  '\n\n§ O CONSELHO VALORIZA O TRABALHADOR: ': '\n\n§ THE COUNCIL VALUES THE WORKER: ',
  '\n\n§ INDICADOR FÍSICO EM VIGOR: ': '\n\n§ PHYSICAL INDICATOR IN EFFECT: ',
  '\nAnomalia correspondente registrada em EXAME FÍSICO autoriza detenção.': '\nA matching anomaly recorded in PHYSICAL EXAM authorizes detention.',
  '\n\n✎ (rabiscado a lápis na margem, por alguém do turno anterior)\n"': '\n\n✎ (scrawled in pencil in the margin, by someone from the previous shift)\n"',
  'Clique num país para ver seus dados, selo e o estado da fronteira hoje.': 'Click a country to see its details, seal, and the state of the border today.',
  'gentílico: ': 'demonym: ',
  'ENTRADA PROIBIDA HOJE': 'ENTRY FORBIDDEN TODAY',
  'ENTRADA PERMITIDA': 'ENTRY PERMITTED',
  'MINISTÉRIO DE TRIAGEM': 'MINISTRY OF SCREENING',
  'Um homem detido na Operação "Sangue Limpo" foi solto sem explicação. A esposa, enfermeira, não quis dar entrevista. Só disse: "ele está vivo".': 'A man detained in Operation "Clean Blood" was released without explanation. His wife, a nurse, declined an interview. She only said: "he\'s alive".',
  'Não há mais registro de visitas de familiares aos detidos da Operação "Sangue Limpo". O Ministério diz que isso "simplifica o processo".': 'There is no longer any record of family visits to those detained in Operation "Clean Blood". The Ministry says this "simplifies the process".',
  'Você foi sorteado na Loteria de Ofícios para servir como INSPETOR DE FRONTEIRA no Posto Nº 7, por 48 dias.\n\nHorário: 08h às 18h. Você chega em casa às 20h30.\nSalário: ': 'You have been drawn in the Lottery of Trades to serve as BORDER INSPECTOR at Post No. 7, for 48 days.\n\nHours: 8am to 6pm. You get home at 8:30pm.\nSalary: ',
  ' por decisão correta.\nErros: advertência; a partir da 3ª do dia, multa.\n\nSua família depende do seu salário: Vessa (sua esposa), Tomi (8 anos), Dario (15 anos, do seu primeiro casamento) e sua mãe, Odila.\n\nAssine abaixo. A recusa não consta do formulário como opção.': ' per correct decision.\nErrors: a warning; from the 3rd of the day on, a fine.\n\nYour family depends on your salary: Vessa (your wife), Tomi (8), Dario (15, from your first marriage) and your mother, Odila.\n\nSign below. Refusal is not listed on the form as an option.',
  ...
  'O Vidro Não Devolve': "The Glass Doesn't Give Back",
  'Sangue Frio no Guichê': 'Cold Blood at the Window',
  'O Faro': 'The Nose',
  'Rotina': 'Routine',
  'Sete Portas': 'Seven Doors',

  /* ---- versos das conquistas (só aparecem quando ela é obtida) ---- */
  'Você fechou o primeiro expediente. Nada disso parecia grave ainda.':
    "You closed out your first shift. None of it seemed serious yet.",
  'Chegou ao fim com o cadastro limpo e sem um suborno. O Ministério gosta do senhor. Pense nisso.':
    'Reached the end with a clean record and not a single bribe. The Ministry likes you, sir. Think about that.',
  'Atravessou a fronteira sem um papel sequer, depois de 48 dias exigindo todos.':
    'Crossed the border without a single paper, after 48 days demanding every one.',
  'Seis atravessaram. A cidade ficou em paz. Ninguém mais grita à noite.':
    'Six got through. The city went quiet. No one screams at night anymore.',
  'Chegou ao dia 48 e abriu a porta do banheiro.':
    'Reached day 48 and opened the bathroom door.',
  'Sobreviveu duas vezes ao que entra sem constar do livro. Carimbe qualquer coisa. E deixe ir.':
    "Survived twice what enters without appearing in the ledger. Stamp anything. And let it go.",
  'Você olhou de perto. Ele também.':
    'You looked closely. So did he.',
  'Os quatro chegaram vivos ao dia 48. Vessa, Tomi, Dario e sua mãe.':
    'All four made it to day 48 alive. Vessa, Tomi, Dario, and your mother.',
  '48 dias sem aceitar um único envelope por baixo do vidro.':
    '48 days without accepting a single envelope under the glass.',
  'Ninguém dormiu com frio nesta casa.':
    'No one slept cold in this house.',
  'O Contador veio conferir a conta e voltou algemado.':
    'The Accountant came to check the tally and left in handcuffs.',
  'O amigo do Tomi avisou. O amigo do Tomi acertou. O amigo do Tomi não existe.':
    "Tomi's friend warned you. Tomi's friend was right. Tomi's friend doesn't exist.",
  'Olhou no espelho e reconheceu o que estava lá.':
    'Looked in the mirror and recognized what was there.',
  'Deteve ou abateu um agressor no guichê antes que ele agisse.':
    'Detained or brought down an attacker at the window before he could act.',
  'Oito Alternados identificados. Nenhum inocente detido no caminho.':
    'Eight Alternates identified. No innocent detained along the way.',
  'Seis envelopes ou mais. Parou de contar antes do Ministério contar por você.':
    'Six envelopes or more. You stopped counting before the Ministry counted for you.',
  'Uma menção, um nome, uma porta que não abriu mais.':
    'One mention, one name, one door that never opened again.',
  ...
  'DATA': 'DATE',
  'POSTO': 'POST',
  /* ---- arquivo de cadernetas (8 saves) + morte que reabre o dia ---- */
  'ARQUIVO DE CADERNETAS — POSTO Nº 7': 'NOTEBOOK ARCHIVE — POST Nº 7',
  'CADERNETAS': 'NOTEBOOKS',
  'CADERNETAS — SALVAR / CARREGAR': 'NOTEBOOKS — SAVE / LOAD',
  'CADERNETA DE SERVIÇO': 'SERVICE NOTEBOOK',
  '— em branco —': '— blank —',
  'Capa sem etiqueta. Nenhum expediente consta.': 'Unlabelled cover. No shift on record.',
  'ARQUIVADA': 'FILED',
  'GRAVAR': 'RECORD',
  'REGRAVAR': 'OVERWRITE',
  'ABRIR': 'OPEN',
  ...
  'TURNO': 'SHIFT',
  'gravada em ': 'recorded ',
  'O expediente em curso é o <b>DIA</b> ': 'The shift under way is <b>DAY</b> ',
  '. Grave numa caderneta livre — ou por cima de uma velha, que é como o Ministério faz.':
    '. Record it in a free notebook — or over an old one, which is how the Ministry does it.',
  'Oito cadernetas cabem nesta prateleira. O turno também se grava sozinho todo fim de expediente, e a morte devolve o inspetor à manhã do mesmo dia.':
    'Eight notebooks fit on this shelf. The shift also records itself at the end of every day, and death returns the inspector to the morning of the same day.',
  'REGRAVAR A CADERNETA ': 'OVERWRITE NOTEBOOK ',
  'ABRIR A CADERNETA ': 'OPEN NOTEBOOK ',
  'DESCARTAR A CADERNETA ': 'DESTROY NOTEBOOK ',
  'O expediente arquivado nesta caderneta será substituído pelo atual. Não há segunda via.':
    'The shift filed in this notebook will be replaced by the current one. There is no second copy.',
  'O expediente em curso é abandonado e o inspetor volta à manhã registrada nesta caderneta.':
    'The shift under way is abandoned and the inspector returns to the morning recorded in this notebook.',
  'A caderneta é destruída. O que estava escrito nela deixa de ter existido — é assim que este país arquiva.':
    'The notebook is destroyed. What was written in it stops having existed — that is how this country files things.',
  'DEIXAR COMO ESTÁ': 'LEAVE IT',
  'ARQUIVO CHEIO': 'ARCHIVE FULL',
  'Não há espaço no arquivo desta máquina para mais uma caderneta. Descarte uma antiga e tente de novo.':
    'There is no room in this machine\'s archive for another notebook. Destroy an old one and try again.',
  'ENTENDIDO': 'UNDERSTOOD',
  'REABRIR O DIA': 'REOPEN THE DAY',
  '08:00': '08:00',
  '"Escolha, então. Obrigado pela franqueza."': '"Choose, then. Thank you for your candour."',
  'FINAL — A CONTA FECHADA': 'ENDING — THE ACCOUNT SETTLED',
  'A Conta Fechada': 'The Account Settled',
  /* ---- caderno da casa / cautelas ---- */
  'MORADORES DO APARTAMENTO': 'RESIDENTS OF THE APARTMENT',
  'CONTAS DO DIA': "TODAY'S ACCOUNTS",
  'CAUTELAS DE RACIONAMENTO': 'RATION COUPONS',
  'CAUTELA': 'COUPON',
  'Saldo em caixa': 'Cash on hand',
  'Aluguel (descontado à noite)': 'Rent (deducted at night)',
  'Sobra depois da noite': 'Left after tonight',
  'Comida para a família': 'Food for the family',
  'Carvão para o fogão': 'Coal for the stove',
  'Remédio para': 'Medicine for',
  'Calibração do detector (sem recibo)': 'Detector calibration (no receipt)',
  'bem': 'well',
  'com fome': 'hungry',
  'DOENTE': 'ILL',
  'falecido(a)': 'deceased',
...
const I18N_ES = {
  ...
  'MINISTÉRIO DE TRIAGEM · FOLHA DE PONTO — POSTO Nº 7': 'MINISTERIO DE TRIAJE · HOJA DE ASISTENCIA — PUESTO Nº 7',
  ...
  'GAVETA A · EXPEDIENTE': 'CAJÓN A · DESPACHO', 'GAVETA B · TRIAGEM': 'CAJÓN B · CRIBADO',
  'MAPA': 'MAPA', 'LUPA': 'LUPA', 'DOSSIÊ': 'EXPEDIENTE',
  'Abrir/fechar a gaveta': 'Abrir/cerrar el cajón',
  'Carta de fronteiras — arraste até a MESA para abrir': 'Carta de fronteras — arrastra hasta la MESA para abrir',
  'Lupa de inspeção — arraste até os documentos ou o vidro': 'Lupa de inspección — arrastra hasta los documentos o el cristal',
  'Ficha de exame físico — arraste até o cidadão (10 min)': 'Ficha de examen físico — arrastra hasta el ciudadano (10 min)',
  'Dossiê da vida documentada — arraste até o cidadão (10 min)': 'Expediente de la vida documentada — arrastra hasta el ciudadano (10 min)',
  'Comunicado oficial do dia — clique para reler': 'Comunicado oficial del día — haz clic para releer',
  'REVISTAR BAGAGEM': 'REVISAR EQUIPAJE',
  /* atentados no guichê */
  'ARMA — ATIRE OU DETENHA': 'ARMA — DISPARA O DETÉN',
  'EXPLOSIVOS — DETENHA OU ATIRE': 'EXPLOSIVOS — DETÉN O DISPARA',
  'Pistola de serviço — clique para sacar': 'Pistola de servicio — haz clic para desenfundar',
  'OCORRÊNCIA NO POSTO Nº 7': 'INCIDENTE EN EL PUESTO Nº 7',
  'NEUTRALIZADO NO GUICHÊ': 'NEUTRALIZADO EN LA VENTANILLA',
  'DETIDO ANTES DE AGIR': 'DETENIDO ANTES DE ACTUAR',
  'ARQUIVAR': 'ARCHIVAR',
  /* transmissão oficial */
  'TRANSMISSÃO OFICIAL': 'TRANSMISIÓN OFICIAL',
  'DESLIGAR O APARELHO': 'APAGAR EL APARATO',
  'PORTA-VOZ DO MINISTÉRIO': 'PORTAVOZ DEL MINISTERIO',
  'COMANDO NACIONAL MEHRVOLK': 'COMANDO NACIONAL MEHRVOLK',
  'INSTITUTO DE FENOTIPIA': 'INSTITUTO DE FENOTIPIA',
  'BOLETIM DE EMERGÊNCIA': 'BOLETÍN DE EMERGENCIA',
  'CONSELHO POPULAR DE OSTERIA': 'CONSEJO POPULAR DE OSTERIA',
  '— SEM IDENTIFICAÇÃO —': '— SIN IDENTIFICACIÓN —',
  /* o corredor e o espelho */
  'E — Abrir a porta do banheiro': 'E — Abrir la puerta del baño',
  'PULAR': 'SALTAR',
  'Carimbo APROVADO — arraste até um documento e solte': 'Sello APROBADO — arrastra hasta un documento y suelta',
  'Almofada de tinta — encoste o carimbo para entintar': 'Almohadilla de tinta — apoya el sello aquí para entintar',
  'Sineta do balcão': 'Timbre del mostrador',
  'Carimbo REJEITADO — arraste até um documento e solte': 'Sello RECHAZADO — arrastra hasta un documento y suelta',
  'Lupa de exame — arraste até o cidadão (10 min); a bagagem se revista por ela': 'Lupa de examen — arrastra hasta el ciudadano (10 min); el equipaje se revisa con ella',
  ...
  /* ---- casa ---- */
  'WASD/setas andar · mova o mouse p/ olhar · E interagir':
    'WASD/flechas para caminar · mueve el ratón para mirar · E interactuar',
  ...
  'FINAL — O CARIMBO CONHECIDO': 'FINAL — EL SELLO CONOCIDO',
  'O relógio da sala marca 20h31 quando você percebe que está de pé, atravessando o próprio corredor, como se já tivesse feito isso a vida inteira — o que, no fundo, é quase verdade.\n\nDo outro lado do vidro alguém desliza documentos pela bandeja. Nome, foto, 48 assinaturas de turno, nenhuma perfeitamente igual à anterior. Ninguém nunca reparou nisso. Você também não reparava, nos outros.\n\nA mão pega o carimbo antes de você decidir pegar. É um músculo que já sabe o movimento, treinado por 47 repetições.\n\nAPROVADO. A tinta seca depressa, como sempre secou. Do outro lado, alguém com o seu rosto guarda os papéis, levanta, sai andando — talvez para uma vida que é a sua. Você continua sentado mais um instante. Não é dúvida. É só o corpo, ainda tentando lembrar qual dos dois ficou com o lugar de verdade.':
    'El reloj de la sala marca las 20:31 cuando notas que estás de pie, cruzando tu propio pasillo, como si ya lo hubieras hecho toda la vida — lo cual, en el fondo, es casi verdad.\n\nDel otro lado del vidrio alguien desliza documentos por la bandeja. Nombre, foto, 48 firmas de turno, ninguna perfectamente igual a la anterior. Nadie lo notó nunca. Tú tampoco lo notabas en los demás.\n\nLa mano toma el sello antes de que decidas tomarlo. Es un músculo que ya conoce el movimiento, entrenado en 47 repeticiones.\n\nAPROBADO. La tinta se seca rápido, como siempre se secó. Del otro lado, alguien con tu rostro guarda los papeles, se levanta, se aleja — tal vez hacia una vida que es la tuya. Te quedas sentado un instante más. No es duda. Es solo el cuerpo, todavía tratando de recordar cuál de los dos se quedó con el lugar de verdad.',

  'FINAL — O CARIMBO NÃO HESITOU': 'FINAL — EL SELLO NO DUDÓ',
  'A mão sobe e desce antes mesmo de você acabar de reconhecer o próprio rosto do outro lado do vidro. Rápido. Seco. Como sempre foi.\n\nO problema é a memória, que chega um segundo atrasada: várias pessoas inocentes saíram do seu guichê algemadas porque duvidar de menos era mais rápido do que duvidar direito. Você chamou isso de rigor, na época. De fazer o trabalho como manda o regulamento.\n\nO reflexo não reclama do carimbo. Por que reclamaria? Ele é você, e você nunca precisou de muito para se convencer de nada.\n\nAPROVADO. A tinta seca. Do outro lado, alguém com sua cara junta os papéis e sai andando, leve, como se nada ali tivesse pesado — porque, para ele, nunca pesou o bastante.':
    'La mano sube y baja antes de que el resto de ti termine de reconocer tu propio rostro del otro lado del vidrio. Rápido. Seco. Como siempre fue.\n\nEl problema es la memoria, que llega un segundo tarde: varias personas inocentes salieron de tu ventanilla esposadas porque dudar menos era más rápido que dudar bien. Lo llamaste rigor, en ese momento. Hacer el trabajo como manda el reglamento.\n\nEl reflejo no se queja del sello. ¿Por qué se quejaría? Es tú, y nunca necesitaste mucho para convencerte de nada.\n\nAPROBADO. La tinta se seca. Del otro lado, alguien con tu cara junta los papeles y se aleja, liviano, como si nada ahí hubiera pesado — porque, para él, nunca pesó lo suficiente.',

  'FINAL — O PREÇO DO PRÓPRIO CARIMBO': 'FINAL — EL PRECIO DEL PROPIO SELLO',
  'Você desliza os documentos pela bandeja e, por hábito, os dedos procuram um envelope que não está lá. É você do outro lado do vidro — subornar a si mesmo seria, no mínimo, redundante.\n\nFoi fácil, lá atrás. Um envelope aqui, outro ali, ninguém contando alto o bastante para alguém notar. O dinheiro pagou remédio, aquecimento, um mês de aluguel adiantado. Também pagou, sem que ninguém assinasse nada, a passagem de algumas pessoas que não deviam passar.\n\nO reflexo espera, com a mesma cara que você faz quando finge que não está fazendo conta.\n\nVocê aprova. Claro que aprova: o seu próprio carimbo, pelo menos esse, sempre esteve à venda para você — de graça.':
    'Deslizas los documentos por la bandeja y, por costumbre, tus dedos buscan un sobre que no está. Eres tú del otro lado del vidrio — sobornarte a ti mismo sería, como mínimo, redundante.\n\nFue fácil, en su momento. Un sobre aquí, otro allá, nadie contando lo bastante alto para que alguien lo notara. El dinero pagó remedio, calefacción, un mes de alquiler adelantado. También pagó, sin que nadie firmara nada, el paso de algunas personas que no debían pasar.\n\nEl reflejo espera, con la misma cara que pones cuando finges que no estás haciendo cuentas.\n\nApruebas. Claro que apruebas: tu propio sello, al menos ese, siempre estuvo en venta para ti — gratis.',

  'FINAL — O PORTÃO DE FERRO': 'FINAL — EL PORTÓN DE HIERRO',
  'Rejeitou mais do que aprovou. Em algum dia que você não sabe apontar, rejeitar virou o padrão — e aprovar, a exceção que precisava se explicar.\n\nHá gente na fronteira de Osteria, hoje, que nunca vai saber por que deu meia-volta: uma vírgula fora do lugar, um selo meio desbotado, um segundo de dúvida que você preferiu não arriscar. Algumas dessas pessoas, você sabe, não tinham para onde voltar.\n\nO reflexo é implacável do mesmo jeito. Você reconhece o gesto assim que ele começa — o carimbo vermelho decidido antes mesmo de terminar de ler — e aprova a si mesmo sem pestanejar. É a única coisa em você que nunca vacila: o próprio rigor.\n\nO portão fica fechado para quase todo mundo. Para você, sempre esteve escancarado.':
    'Rechazaste más de lo que aprobaste. En algún día que no sabrías señalar, rechazar se volvió la norma — y aprobar, la excepción que necesitaba justificarse.\n\nHay gente en la frontera de Osteria, hoy, que nunca sabrá por qué dio media vuelta: una coma fuera de lugar, un sello algo desteñido, un segundo de duda que preferiste no arriesgar. Algunas de esas personas, lo sabes, no tenían adónde volver.\n\nEl reflejo es igual de implacable. Reconoces el gesto apenas empieza — el sello rojo decidido antes incluso de terminar de leer — y te apruebas a ti mismo sin pestañear. Es lo único en ti que nunca vacila: tu propio rigor.\n\nEl portón queda cerrado para casi todos. Para ti, siempre estuvo abierto de par en par.',

  'FINAL — A MÃO QUE NÃO TREMEU DO JEITO ERRADO': 'FINAL — LA MANO QUE NO TEMBLÓ DEL MODO EQUIVOCADO',
  'Nenhum inocente saiu do seu guichê algemado. Nem um, em 48 dias. Não é o tipo de número que sai em boletim do Ministério — mas você sabe, e é seu.\n\nAjudou quem deu para ajudar, quando havia como ajudar sem que ninguém visse: um bilhete guardado em vez de queimado, um nome que você não perguntou de novo na segunda vez que apareceu.\n\nO reflexo se aprova, e pela primeira vez em 48 dias isso não soa como um gesto vazio. Soa quase como algo que se ganhou.\n\nVocê não salvou o país. Não salvou nem o posto. Salvou umas poucas pessoas específicas, com nome — de quem nunca soube dizer se eram humanas — e decidiu que a pergunta importava menos do que a resposta que deu.':
    'Ningún inocente salió de tu ventanilla esposado. Ni uno, en 48 días. No es el tipo de número que aparece en un boletín del Ministerio — pero tú lo sabes, y es tuyo.\n\nAyudaste a quien pudiste, cuando hubo forma de ayudar sin que nadie viera: una nota guardada en vez de quemada, un nombre que no volviste a preguntar la segunda vez que apareció.\n\nEl reflejo se aprueba a sí mismo, y por primera vez en 48 días eso no suena a gesto vacío. Suena casi a algo ganado.\n\nNo salvaste al país. Ni siquiera salvaste el puesto. Salvaste a unas pocas personas concretas, con nombre — de las que nunca supiste con certeza si eran humanas — y decidiste que la pregunta importaba menos que la respuesta que diste.',

  'FINAL — A MÁQUINA PERFEITA': 'FINAL — LA MÁQUINA PERFECTA',
  'Zero erros no registro. Trinta e cinco decisões corretas, talvez mais — o número exato já nem importa: passado certo ponto, "perfeito" para de ser contável e vira só um jeito de ser.\n\nNos últimos dias os colegas param de te chamar pelo nome. Dizem "o modelo", baixinho, meio elogio, meio aviso. Ninguém acerta 48 dias seguidos continuando humano o tempo inteiro.\n\nO reflexo aprova e a mão não treme — nunca tremeu, nem uma vez, mesmo nas vezes em que devia.\n\nVocê sai do posto sem uma marca sequer no registro. Já não sabe se isso prova que fez tudo certo ou só que faz tempo que parou de sentir a diferença.':
    'Cero errores en el registro. Treinta y cinco decisiones correctas, tal vez más — el número exacto ya ni importa: pasado cierto punto, "perfecto" deja de ser contable y se vuelve solo una forma de ser.\n\nEn estos últimos días tus colegas dejan de llamarte por tu nombre. Dicen "el modelo", en voz baja, mitad elogio, mitad advertencia. Nadie acierta 48 días seguidos siendo humano todo el tiempo.\n\nEl reflejo aprueba y la mano no tiembla — nunca tembló, ni una vez, ni siquiera las veces en que debía.\n\nSales del puesto sin una sola marca en tu historial. Ya no sabes si eso prueba que hiciste todo bien o solo que hace tiempo dejaste de sentir la diferencia.',

  'FINAL — A MESA COM UM LUGAR A MENOS': 'FINAL — LA MESA CON UN LUGAR DE MENOS',
  'A casa não ficou vazia. Ficou incompleta — o que, de um jeito estranho, dói mais: a rotina segue, o jantar é servido, só que sempre falta um prato na pilha que ninguém guarda.\n\nQuem ficou não fala do assunto. Fala ao redor dele, com um cuidado que vocês nunca precisaram ter uns com os outros antes.\n\nVocê carimbou papel por 48 dias tentando decidir quem entra e quem fica de fora. Não conseguiu decidir a única coisa que de fato importava: quem, na sua própria casa, sobrevive ao inverno.\n\nO posto reabre amanhã, com ou sem você. A mesa em casa, também.':
    'La casa no quedó vacía. Quedó incompleta — lo que, de un modo extraño, duele más: la rutina sigue, la cena se sirve, solo que siempre falta un plato en la pila que nadie guarda.\n\nLos que se quedaron no hablan del tema. Hablan alrededor de él, con un cuidado que nunca antes necesitaron tener entre ustedes.\n\nSellaste papel durante 48 días tratando de decidir quién entra y quién se queda afuera. Nunca lograste decidir lo único que de verdad importaba: quién, en tu propia casa, sobrevive al invierno.\n\nEl puesto reabre mañana, contigo o sin ti. La mesa en casa, también.',

  'FINAL — O CORREDOR VAZIO': 'FINAL — EL PASILLO VACÍO',
  'No dia 48, o corredor do Bloco 14 ainda tem sete portas. Uma delas nunca mais abriu.\n\nVocê tentou não contar os dias. Contou de qualquer jeito: três, entre a menção e os móveis saindo de manhã. Ninguém no prédio pergunta pelo apartamento vazio — perguntar virou o tipo de coisa que move as pessoas para uma porta diferente da sua.\n\nO sargento disse "excelente memória, inspetor" e nunca mais precisou de outra. Você forneceu uma vez. Isso basta para sempre ser, no fichário de alguém, a pessoa que fornece.\n\nOs quarenta e oito dias terminam. O corredor continua com sete portas. Você aprende a olhar só para a sua.':
    'El día 48, el pasillo del Bloque 14 todavía tiene siete puertas. Una de ellas nunca volvió a abrirse.\n\nTrataste de no contar los días. Los contaste de todos modos: tres, entre la mención y los muebles saliendo por la mañana. Nadie en el edificio pregunta por el apartamento vacío — preguntar se volvió el tipo de cosa que mueve a la gente hacia una puerta distinta de la tuya.\n\nEl sargento dijo "excelente memoria, inspector" y nunca más necesitó preguntarte de nuevo. Colaboraste una vez. Eso basta para ser siempre, en el archivo de alguien, la persona que colabora.\n\nLos cuarenta y ocho días terminan. El pasillo sigue con siete puertas. Aprendes a mirar solo la tuya.',

  'FINAL — O ENVELOPE VIROU ROTINA': 'FINAL — EL SOBRE SE VOLVIÓ RUTINA',
  'Ninguém mais desliza um envelope escondido. Nos últimos dias, colocam em cima da pilha de documentos, junto com o passaporte, como mais um papel a carimbar.\n\nVocê perdeu a conta em algum lugar entre o terceiro e o sétimo. Não perdeu o hábito de contar o dinheiro depois, no banheiro do posto, com a porta trancada.\n\nOs colegas sabem. O supervisor sabe, e o supervisor também sabe quanto custa saber e ficar calado. É o tipo de aritmética que o Ministério nunca ensina, mas que todo mundo aprende sozinho até o dia 20.\n\nNo dia 48, o guichê fecha como sempre fechou: no horário, sem escândalo. Você sai com mais dinheiro do que qualquer salário jamais te daria, e menos certeza do que aprovou de verdade do que qualquer inspetor deveria ter.':
    'Ya nadie desliza un sobre escondido. En los últimos días, lo ponen encima de la pila de documentos, junto al pasaporte, como un papel más para sellar.\n\nPerdiste la cuenta en algún punto entre el tercero y el séptimo. No perdiste la costumbre de contar el dinero después, en el baño del puesto, con la puerta cerrada.\n\nTus colegas lo saben. El supervisor lo sabe, y el supervisor también sabe cuánto cuesta saber y quedarse callado. Es el tipo de aritmética que el Ministerio nunca enseña, pero que todos aprenden solos antes del día 20.\n\nEl día 48, la ventanilla cierra como siempre cerró: a tiempo, sin escándalo. Te vas con más dinero del que cualquier salario te habría dado, y con menos certeza sobre lo que en verdad aprobaste de la que cualquier inspector debería tener.',

  'FINAL — A PONTARIA ERRADA': 'FINAL — LA PUNTERÍA EQUIVOCADA',
  'O relatório do Ministério não sabe o que você fez de verdade. Sabe os números, e números não perdoam.\n\nGente inocente passou pelo seu guichê e saiu detida. Alternados, na mesma semana, passaram pelo mesmo guichê e saíram livres, sem que você suspeitasse de nada.\n\nNão existe uma palavra oficial para isso. Você inventou uma sozinho, numa madrugada sem sono: errar para os dois lados ao mesmo tempo. Bateu na porta errada da paranoia e na porta errada do descuido, na mesma semana, com o mesmo carimbo.\n\nDia 48. Continua sem saber se prendeu gente demais ou gente de menos. As duas coisas são verdade ao mesmo tempo — e isso, só isso, você tem certeza.':
    'El informe del Ministerio no sabe lo que hiciste de verdad. Sabe los números, y los números no perdonan.\n\nPersonas inocentes pasaron por tu ventanilla y salieron detenidas. Alternados, la misma semana, pasaron por la misma ventanilla y salieron libres, sin que sospecharas nada.\n\nNo hay una palabra oficial para eso. Inventaste una, solo, en una madrugada sin sueño: equivocarte en los dos sentidos a la vez. Golpeaste la puerta equivocada de la paranoia y la puerta equivocada del descuido, en la misma semana, con el mismo sello.\n\nDía 48. Sigues sin saber si detuviste a demasiada gente o a muy poca. Las dos cosas son verdad al mismo tiempo — y eso, solo eso, tienes por seguro.',

  'FINAL — A MIRA CERTA': 'FINAL — LA PUNTERÍA CERTERA',
  'Oito. O número fica repetindo na sua cabeça mesmo depois que você para de contar: oito Alternados identificados, detidos, removidos do fluxo — e nenhum inocente arrastado junto no caminho.\n\nOs colegas comentam baixo, quase respeito, quase medo: você tem "faro". Ninguém usa a palavra certa, porque a palavra certa implicaria que você sabe algo que o Ministério não ensina em nenhum manual.\n\nTalvez seja mesmo faro. Talvez seja sorte disfarçada de método, oito vezes seguidas. Talvez os oito só fossem particularmente descuidados, e o próximo — o que você não vai pegar — seja bom demais para o olho que você sempre teve.\n\nNo dia 48, o Ministério manda uma carta de reconhecimento formal e um convite para "consultoria de treinamento". Você não sabe se aceita. Sabe, com uma certeza fria que não devia ter, que vai continuar olhando as pessoas do jeito que aprendeu a olhar, pelo resto da vida, dentro ou fora do posto.':
    'Ocho. El número se repite en tu cabeza incluso después de que dejas de contar: ocho Alternados identificados, detenidos, retirados del flujo — y ningún inocente arrastrado en el camino.\n\nLos colegas lo comentan en voz baja, casi respeto, casi miedo: tienes "olfato". Nadie usa la palabra correcta, porque la palabra correcta implicaría que sabes algo que el Ministerio no enseña en ningún manual.\n\nQuizás sea olfato de verdad. Quizás sea suerte disfrazada de método, ocho veces seguidas. Quizás los ocho solo fueron particularmente descuidados, y el próximo — el que no vas a atrapar — sea demasiado bueno para el ojo que siempre tuviste.\n\nEl día 48, el Ministerio manda una carta de reconocimiento formal y una invitación a "consultoría de entrenamiento". No sabes si aceptar. Sabes, con una certeza fría que no deberías tener, que vas a seguir mirando a las personas del modo en que aprendiste a mirarlas, por el resto de tu vida, dentro o fuera del puesto.',
  ...
  'Espelhos usados pela metade do preço. Não perguntamos por que você não quer mais o seu.': 'Espejos usados a mitad de precio. No preguntamos por qué ya no quieres el tuyo.',
  'Repintamos o retrato da sua família enquanto você espera. Fica igualzinho. Igualzinho.': 'Repintamos el retrato de tu familia mientras esperas. Queda igualito. Igualito.',
  'Curso noturno: reconheça a própria letra em três lições. Certificado oficial.': 'Curso nocturno: reconoce tu propia letra en tres lecciones. Certificado oficial.',
  'Aluga-se quarto sem janelas. "Mais seguro assim", diz o senhorio, sorrindo.': 'Se alquila cuarto sin ventanas. "Más seguro así", dice el casero, sonriendo.',
  ...
  'Tomi voltou da escola com a cartilha nova e pediu para ver as suas mãos. Olhou com cuidado, contou os calos e disse: "Passou." Depois riu, porque para ele era um jogo. Vessa não riu. Você também não conseguiu.':
    'Tomi volvió de la escuela con la cartilla nueva y pidió ver sus manos. Las miró con cuidado, contó los callos y dijo: "Pasó." Después se rió, porque para él era un juego. Vessa no se rió. Usted tampoco pudo.',
  'Tomi desenhou a família na escola. A professora elogiou — mas perguntou por que ele desenhou "papai com dois rostos". Ele não soube explicar. Você também não.':
  ...
  'Trocaram o retrato da parede do saguão pela terceira vez em dois meses. O prego é o mesmo, o buraco é o mesmo, só o rosto muda. Sua mãe passou por ele sem olhar e comentou: "Aquele prego já viu mais governo do que eu."':
    'Cambiaron el retrato de la pared del vestíbulo por tercera vez en dos meses. El clavo es el mismo, el agujero es el mismo, solo cambia el rostro. Su madre pasó por delante sin mirarlo y comentó: "Ese clavo ya vio más gobiernos que yo."',
  'Dario chegou tarde e com terra no casaco. Disse que ajudou a carregar caixas na estação. Não há mais trens na estação desde o dia 27. Você não perguntou de novo — e passou a noite calculando há quanto tempo o seu filho aprendeu a mentir para te proteger.':
    'Dario llegó tarde y con tierra en el abrigo. Dijo que ayudó a cargar cajas en la estación. No hay trenes en la estación desde el día 27. Usted no volvió a preguntar — y pasó la noche calculando hace cuánto tiempo su hijo aprendió a mentirle para protegerlo.',
  'A família realocada bateu na sua porta pela primeira vez. O homem sorriu e ofereceu pão morno. Ninguém nunca os viu comprando nada. Vessa agradeceu e trancou a porta com as duas voltas.':
  ...
  'Não durmo direito desde o último comunicado.': 'No duermo bien desde el último comunicado.',
  'O senhor tem um rosto fácil de esquecer. No meu ofício, isso é elogio.': 'Usted tiene un rostro fácil de olvidar. En mi oficio, eso es un elogio.',
  'Meu pai dizia: fila boa é fila que anda. Esta anda?': 'Mi padre decía: buena fila es la que avanza. ¿Esta avanza?',
  'Prometo que não vou dar trabalho. Todo mundo promete, eu sei.': 'Prometo que no voy a dar problemas. Todos lo prometen, lo sé.',
  'O jornal de hoje diz que melhorou. O de ontem também dizia.': 'El diario de hoy dice que mejoró. El de ayer también lo decía.',
  'Eu tenho os documentos certos. Eu SOU a pessoa certa. Não sou?': 'Tengo los documentos correctos. SOY la persona correcta. ¿No?',
  'Reparti meu pão com o da frente na fila. Ele não comeu. Só olhou.': 'Compartí mi pan con el de adelante en la fila. No comió. Solo miró.',
  'Ouvi que amanhã não abre. Ouvi que nunca mais abre.': 'Oí que mañana no abre. Oí que no abre nunca más.',
  ...
  'Ela dormiu agora. Por favor… fale baixo.': 'Se acaba de dormir. Por favor… hable bajo.',
  'Nasceu na estrada. Não tem documento ainda. Ninguém me disse que precisava.': 'Nació en el camino. Todavía no tiene documento. Nadie me dijo que hacía falta.',
  'Ele não chorou uma vez a viagem inteira. Bom menino.': 'No lloró ni una vez en todo el viaje. Buen niño.',
  'Só quero que ela cresça do outro lado. Só isso.': 'Solo quiero que crezca del otro lado. Nada más.',
  'O leite secou faz dois dias. Ela ainda não sabe reclamar. Eu sei.': 'La leche se secó hace dos días. Ella todavía no sabe quejarse. Yo sí.',
  'É o único documento que eu tenho dele: sei o peso dele de cor.': 'Es el único documento que tengo de él: sé su peso de memoria.',
  'Se precisar carimbar, carimbe rápido. Ela acorda com barulho de metal.': 'Si tiene que sellar, séllelo rápido. Ella se despierta con el ruido del metal.',
  'Diz "bom dia" pro moço. — …ele é tímido.': 'Dile "buenos días" al señor. — …es tímido.',
  'Ela não solta a minha mão desde que saímos de casa.': 'No me suelta la mano desde que salimos de casa.',
  'Meu filho. Os papéis dele estão junto dos meus. Estão, sim.': 'Mi hijo. Sus papeles están junto a los míos. Sí que están.',
  'Não olhe assim pra ela. Ela não fez nada. Nenhum de nós fez.': 'No la mire así. Ella no hizo nada. Ninguno de nosotros hizo nada.',
  'Ele decorou o próprio nome e o meu. Caso perguntem. Caso a gente se perca.': 'Memorizó su propio nombre y el mío. Por si preguntan. Por si nos perdemos.',
  'Ela perguntou se do outro lado também tem inverno. Não soube mentir.': 'Preguntó si del otro lado también hay invierno. No supe mentir.',
  'Não trouxe brinquedo. Trouxe os documentos dele no lugar. Ele entende — crianças entendem cedo demais aqui.': 'No traje juguete. Traje sus documentos en su lugar. Él entiende — los niños entienden demasiado pronto aquí.',
  'Está tudo em ordem. Não precisa conferir cada carimbo, precisa?': 'Está todo en orden. No hace falta revisar cada sello, ¿verdad?',
  'Os documentos são novos. Bem novos. É que os antigos… se perderam.': 'Los documentos son nuevos. Muy nuevos. Es que los antiguos… se perdieron.',
  'O senhor vai reparar que a data está boa. Está boa, sim.': 'Usted notará que la fecha está bien. Está bien, sí.',
  'Não menti em nada. Bom — nada que o senhor precise anotar.': 'No mentí en nada. Bueno — nada que usted tenga que anotar.',
  'Se olhar rápido, está perfeito. É só não olhar devagar.': 'Si mira rápido, está perfecto. Solo no mire despacio.',
  'Eu lembro de nascer lá. Lembro de tudo. Lembro até do que não vi.': 'Recuerdo haber nacido allí. Recuerdo todo. Recuerdo hasta lo que no vi.',
  'Estou bem. Estou muito bem. O senhor também está bem. Todos estamos bem.': 'Estoy bien. Estoy muy bien. Usted también está bien. Todos estamos bien.',
  'Não precisa me examinar. Eu sei o que procura. Não está em mim.': 'No hace falta examinarme. Sé lo que busca. No está en mí.',
  'Sorrio porque é o correto sorrir. Está correto, o sorriso?': 'Sonrío porque es lo correcto sonreír. ¿Está correcta, la sonrisa?',
  'O frio não me incomoda. Nada me incomoda. É mais prático assim.': 'El frío no me molesta. Nada me molesta. Es más práctico así.',
  'Pisco quando lembro de piscar. Acabei de lembrar.': 'Parpadeo cuando me acuerdo de parpadear. Me acabo de acordar.',
  'Por favor, não me barre. Minha filha está do outro lado há três dias.': 'Por favor, no me rechace. Mi hija está del otro lado hace tres días.',
  'Sei que pareço nervoso. Todo mundo parece, aqui. O senhor não parece?': 'Sé que parezco nervioso. Todos parecen, aquí. ¿Usted no?',
  'As mãos tremem, mas é o frio. Juro que é só o frio.': 'Las manos tiemblan, pero es el frío. Juro que es solo el frío.',
  'A voz? É rouca do frio da estrada. Sempre foi assim.': '¿La voz? Está ronca por el frío del camino. Siempre fue así.',
  'Não repare no casaco largo. Aperta menos, viaja melhor.': 'No repare en el abrigo holgado. Aprieta menos, se viaja mejor.',
  'O nome no passaporte é meu. É meu há tempo suficiente.': 'El nombre del pasaporte es mío. Es mío desde hace tiempo suficiente.',
  'Deixe o cachecol onde está. O pescoço é sensível ao vento.': 'Deje la bufanda donde está. El cuello es sensible al viento.',
  'Essas caixas? Sabonete. Só sabonete importado. Por que pergunta com essa cara, inspetor? Eu tenho uma cara que faz as pessoas perguntarem, é isso, não é? Já ouvi isso antes.': '¿Estas cajas? Jabón. Solo jabón importado. ¿Por qué pregunta con esa cara, inspector? Tengo una cara que hace que la gente pregunte, ¿es eso? Ya lo he oído antes.',
  'Meu marido morreu na estrada, tentando atravessar sem os papéis certos. Eu vim buscar o corpo com os papéis certos. A ironia não escapou a ninguém na minha família, inspetor. Só a ele.': 'Mi marido murió en el camino, intentando cruzar sin los papeles correctos. Vine a buscar el cuerpo con los papeles correctos. La ironía no se le escapó a nadie en mi familia, inspector. Solo a él.',
  'Um dia, inspetor! UM dia! O carimbo diz dia 9, hoje é dia 10, isso é o quê, quatro por cento de atraso? Eu aceito multa. Eu aceito qualquer coisa. Só não me manda de volta pra explicar as caixas de novo.': '¡Un día, inspector! ¡UN día! El sello dice el 9, hoy es el 10, ¿eso qué es, cuatro por ciento de retraso? Acepto la multa. Acepto lo que sea. Solo no me mande de vuelta a explicar las cajas otra vez.',
  'Na Nova República os formulários são digitais e ninguém lê o que a gente escreve mesmo assim. Aqui, pelo menos, o senhor lê. Isso deveria ser reconfortante. Por algum motivo, não é.': 'En la Nueva República los formularios son digitales y nadie lee lo que uno escribe de todos modos. Aquí, al menos, usted lee. Eso debería reconfortar. Por alguna razón, no lo hace.',
  'Meu tio mora do outro lado. Eu nunca conheci ele. Minha mãe disse: mostra os papéis, fica quieto, não conta pra ninguém que é a primeira vez que eu viajo sozinho. Ela não sabia que eu ia contar pro senhor.': 'Mi tío vive del otro lado. Nunca lo conocí. Mi madre dijo: muestra los papeles, quédate callado, no le cuentes a nadie que es la primera vez que viajo solo. No sabía que se lo iba a contar a usted.',
  'O comunicado saiu ontem à noite, inspetor. O cartório abre daqui a três horas. Eu trabalho como contadora há dezoito anos nesta cidade. Ontem eu era osteriana. Hoje sou um formulário que ainda não existe.': 'El comunicado salió anoche, inspector. El registro abre en tres horas. Trabajo como contadora en esta ciudad hace dieciocho años. Ayer era osteriana. Hoy soy un formulario que todavía no existe.',
  'Levaram meu marido terça-feira. "Sangue Limpo", chamam a operação. Ele vendia pão, inspetor. Eu só quero saber se ele está vivo. O senhor tem acesso a essas listas. Eu vi alguém como o senhor consultando uma, uma vez.': 'Se llevaron a mi marido el martes. "Sangre Limpia", llaman a la operación. Vendía pan, inspector. Solo quiero saber si está vivo. Usted tiene acceso a esas listas. Vi a alguien como usted consultando una, una vez.',
  'Na coletiva, quem pergunta demais vira exemplo pros outros. Eu perguntei uma vez de menos e uma vez demais, nessa ordem errada. Aqui eu só quero ser ninguém por um tempo.': 'En la colectiva, quien pregunta demasiado se vuelve ejemplo para los demás. Pregunté una vez de menos y una vez de más, en ese orden equivocado. Aquí solo quiero ser nadie por un tiempo.',
  'A Convenção de Alcorte diz que eu tenho direito a atravessar. O senhor também acredita nisso, ou só carimba nisso?': 'La Convención de Alcorte dice que tengo derecho a cruzar. ¿Usted también cree en eso, o solo sella sobre eso?',
  'Eu ajudei a calibrar esse scanner que o senhor usa. Marcador K-7. Sabe o que eu descobri, inspetor? Ele detecta ansiedade. Só isso. Eu me demiti. Ninguém me perguntou por quê. Ninguém pergunta essas coisas.': 'Ayudé a calibrar ese escáner que usa. El marcador K-7. ¿Sabe qué descubrí, inspector? Detecta ansiedad. Nada más. Renuncié. Nadie me preguntó por qué. Nadie pregunta esas cosas.',
  'Catorze dos meus colegas assinaram aquela carta. Eu não assinei. Vim atravessar mesmo assim, com o passaporte do Andrei — ele não vai precisar mais. Chame isso do que quiser. Eu chamo de covardia com pressa.': 'Catorce de mis colegas firmaron esa carta. Yo no. Vine a cruzar igual, con el pasaporte de Andrei — ya no lo va a necesitar. Llámelo como quiera. Yo lo llamo cobardía con prisa.',
  'Cem moedas, inspetor. Não é suborno, é… taxa de conveniência. Meu banco quebrou terça-feira. O dinheiro que sobrou é literalmente a única coisa real que ainda tenho. Aceite antes que eu perceba isso também.': 'Cien monedas, inspector. No es soborno, es… una tarifa de conveniencia. Mi banco quebró el martes. El dinero que queda es literalmente lo único real que aún tengo. Acéptelo antes de que yo me dé cuenta de eso también.',
  'Meu irmão trabalhava na Estação Central. Trinta e um mortos, disseram. Não disseram nomes. Eu vim ver se o nome dele está numa lista em algum lugar. O senhor tem listas. Todo mundo aqui tem listas.': 'Mi hermano trabajaba en la Estación Central. Treinta y un muertos, dijeron. No dijeron nombres. Vine a ver si su nombre está en una lista en algún lugar. Usted tiene listas. Todos aquí tienen listas.',
  'O senhor… mora no Bloco 14, não mora? Nós dividimos o apartamento agora. Minha esposa disse que a sua não fala com a gente. Eu entendo. Eu também não falaria. Só vim pedir a permissão de trabalho. Preciso alimentar minha família — a que veio comigo, e imagino que a sua também.': 'Usted… vive en el Bloque 14, ¿no? Ahora compartimos el apartamento. Mi esposa dice que la suya no nos habla. Lo entiendo. Yo tampoco lo haría. Solo vine a pedir el permiso de trabajo. Necesito alimentar a mi familia — la que vino conmigo, y me imagino que la suya también.',
  'O regime anterior mentia com carimbos bonitos. O Conselho pelo menos mente honestamente: em papel reciclado, com tinta ruim. Isso é progresso, inspetor. Anote isso. Anote que eu disse isso.': 'El régimen anterior mentía con sellos bonitos. El Consejo al menos miente honestamente: en papel reciclado, con tinta mala. Eso es progreso, inspector. Anótelo. Anote que yo lo dije.',
  'Eu sei o nome da sua esposa. Sei o nome do seu filho, o mais novo. Não é ameaça, inspetor — é currículo. Alguém me paga pra saber esse tipo de coisa sobre gente como o senhor. Achei educado avisar.': 'Sé el nombre de su esposa. Sé el nombre de su hijo, el más pequeño. No es una amenaza, inspector — es un currículum. Alguien me paga por saber ese tipo de cosas sobre gente como usted. Me pareció educado avisarle.',
  'Um nome e um endereço — os seus. Sem assinatura.': 'Un nombre y una dirección — los suyos. Sin firma.',
  'Sou gravadora, inspetor. Carimbos, moldes, chapas — trabalho fino. Esse selo aqui saiu das minhas próprias mãos, e olhe a ironia: nem eu consigo fazer o meu sair perfeito. Ninguém consegue duas vezes seguidas. É por isso que gente como eu ainda tem trabalho.':
    'Soy grabadora, inspector. Sellos, moldes, planchas de imprenta — trabajo fino. Este sello de aquí salió de mis propias manos, y mire la ironía: ni yo consigo que el mío salga perfecto. Nadie lo logra dos veces seguidas. Por eso la gente como yo todavía tiene trabajo.',
  'Se um selo não bater, pode ser mão amiga, não inimiga. — S.K.': 'Si un sello no coincide, puede ser mano amiga, no enemiga. — S.K.',
  'Um lote de cartões de identidade "extraviados" reapareceu, dias depois, nas mãos certas. O Ministério abriu inquérito. Não achou nada — o que, dizem, é a marca de um bom trabalho.':
    'Un lote de tarjetas de identidad "extraviadas" reapareció, días después, en las manos correctas. El Ministerio abrió una investigación. No encontró nada — lo que, dicen, es la marca de un buen trabajo.',
  'Voltei. Não por mim — me mandaram. Queriam saber se o senhor guardou aquele papel ou queimou. Eu disse que não sabia. Foi a única mentira que contei essa semana, o que já é uma boa semana pra mim.': 'Volví. No por mí — me mandaron. Querían saber si usted guardó aquel papel o lo quemó. Dije que no sabía. Fue la única mentira que dije esta semana, lo que ya la hace una buena semana para mí.',
  'Minha irmã disse que um inspetor foi decente com ela, uma vez. Não sei se foi o senhor. Ela também não tinha certeza — disse que os rostos daqui começaram a se confundir pra ela. De qualquer forma: se um dia precisar atravessar sem fila, existe uma rota pelo norte agora que não tem mais fronteira nenhuma vigiando. Ninguém governa lá. É a coisa mais parecida com liberdade que sobrou.': 'Mi hermana dijo que un inspector fue decente con ella, una vez. No sé si fue usted. Ella tampoco estaba segura — dijo que los rostros de aquí empezaron a confundírsele. De todas formas: si algún día necesita cruzar sin fila, ahora hay una ruta por el norte sin ninguna frontera vigilándola. Nadie gobierna allá. Es lo más parecido a la libertad que queda.',
  'Rota do norte: sem posto, sem guarda, sem mapa depois daqui. — M.D.': 'RUTA DEL NORTE: sin puesto, sin guardia, sin mapa después de aquí. — M.D.',
  'Posto Nº 4, sabe onde fica? Fechou semana passada. Levaram o meu antecessor primeiro, depois o Ministério, depois a fila toda de gente que ele tinha aprovado "rápido demais". Eu era bom no meu trabalho, inspetor. Isso não significou nada no fim.': '¿El Puesto Nº 4, sabe dónde queda? Cerró la semana pasada. Se llevaron a mi antecesor primero, después al Ministerio, después a toda la fila de gente que él había aprobado "demasiado rápido". Yo era bueno en mi trabajo, inspector. No significó nada al final.',
  'No Vale a gente parou de perguntar. Alternado, humano, o que for — planta a mesma terra, cava o mesmo poço. Funciona. Não sei se é coragem ou cansaço. Ninguém no Vale sabe também. E olha, ainda estamos todos vivos, o que é mais do que muita gente sensata pode dizer.': 'En el Valle dejamos de preguntar. Alterado, humano, lo que sea — planta la misma tierra, cava el mismo pozo. Funciona. No sé si es coraje o cansancio. Nadie en el Valle lo sabe tampoco. Y mire, todos seguimos vivos, que es más de lo que mucha gente sensata puede decir.',
  'O acompanhante não é uma criança. As pupilas são fendas; os olhos não têm fundo; não pisca. O adulto aperta-o mais forte quando você olha.': 'El acompañante no es un niño. Las pupilas son rendijas; los ojos no tienen fondo; no parpadea. El adulto lo aprieta más fuerte cuando usted mira.',
  'DISCREPÂNCIA DETECTADA — anotada no laudo. Detenção autorizada.': 'DISCREPANCIA DETECTADA — anotada en el informe. Detención autorizada.',
  'Volume denso oculto sob o casaco — algo que não consta na declaração. Reviste a bagagem.': 'Un bulto denso oculto bajo el abrigo — algo que no consta en la declaración. Registre el equipaje.',
  'Nada oculto sob as roupas. Só um corpo com frio.': 'Nada oculto bajo la ropa. Solo un cuerpo con frío.',
  'Biotipo corporal não confere: ombros, quadril e densidade óssea indicam sexo': 'El biotipo corporal no coincide: hombros, cadera y densidad ósea indican sexo',
  'O passaporte declara': 'El pasaporte declara',
  'Assinatura térmica fraca demais. Este corpo está frio para estar vivo.': 'Firma térmica demasiado débil. Este cuerpo está demasiado frío para estar vivo.',
  '.\n\nAplique o regulamento em vigor (painel à direita). Discrepâncias devem ser confirmadas via INSPEÇÃO antes de justificar detenção.': '.\n\nAplique el reglamento vigente (panel a la derecha). Las discrepancias deben confirmarse mediante INSPECCIÓN antes de justificar la detención.',
  '\n\n★ PROCURADO(A) HOJE: ': '\n\n★ BUSCADO(A) HOY: ',
  '\n\n§ COTA DE ADMISSÃO DE HOJE: ': '\n\n§ CUOTA DE ADMISIÓN DE HOY: ',
  '\n\n§ REAJUSTE PATRIÓTICO: ': '\n\n§ REAJUSTE PATRIÓTICO: ',
  '\n\n§ O CONSELHO VALORIZA O TRABALHADOR: ': '\n\n§ EL CONSEJO VALORA AL TRABAJADOR: ',
  '\n\n§ INDICADOR FÍSICO EM VIGOR: ': '\n\n§ INDICADOR FÍSICO VIGENTE: ',
  '\nAnomalia correspondente registrada em EXAME FÍSICO autoriza detenção.': '\nUna anomalía correspondiente registrada en EXAMEN FÍSICO autoriza la detención.',
  '\n\n✎ (rabiscado a lápis na margem, por alguém do turno anterior)\n"': '\n\n✎ (garabateado a lápiz en el margen, por alguien del turno anterior)\n"',
  'Clique num país para ver seus dados, selo e o estado da fronteira hoje.': 'Haz clic en un país para ver sus datos, sello y el estado de la frontera hoy.',
  'gentílico: ': 'gentilicio: ',
  'ENTRADA PROIBIDA HOJE': 'ENTRADA PROHIBIDA HOY',
  'ENTRADA PERMITIDA': 'ENTRADA PERMITIDA',
  'MINISTÉRIO DE TRIAGEM': 'MINISTERIO DE SELECCIÓN',
  'Um homem detido na Operação "Sangue Limpo" foi solto sem explicação. A esposa, enfermeira, não quis dar entrevista. Só disse: "ele está vivo".': 'Un hombre detenido en la Operación "Sangre Limpia" fue liberado sin explicación. La esposa, enfermera, no quiso dar entrevista. Solo dijo: "está vivo".',
  'Não há mais registro de visitas de familiares aos detidos da Operação "Sangue Limpo". O Ministério diz que isso "simplifica o processo".': 'Ya no hay registro de visitas de familiares a los detenidos de la Operación "Sangre Limpia". El Ministerio dice que esto "simplifica el proceso".',
  'Você foi sorteado na Loteria de Ofícios para servir como INSPETOR DE FRONTEIRA no Posto Nº 7, por 48 dias.\n\nHorário: 08h às 18h. Você chega em casa às 20h30.\nSalário: ': 'Ha sido sorteado en la Lotería de Oficios para servir como INSPECTOR DE FRONTERA en el Puesto Nº 7, durante 48 días.\n\nHorario: 08h a 18h. Llega a casa a las 20h30.\nSalario: ',
  ' por decisão correta.\nErros: advertência; a partir da 3ª do dia, multa.\n\nSua família depende do seu salário: Vessa (sua esposa), Tomi (8 anos), Dario (15 anos, do seu primeiro casamento) e sua mãe, Odila.\n\nAssine abaixo. A recusa não consta do formulário como opção.': ' por decisión correcta.\nErrores: advertencia; a partir de la 3ª del día, multa.\n\nSu familia depende de su salario: Vessa (su esposa), Tomi (8 años), Dario (15 años, de su primer matrimonio) y su madre, Odila.\n\nFirme abajo. La negativa no consta en el formulario como opción.',
  ...
  'O Vidro Não Devolve': 'El Vidrio No Devuelve',
  'Sangue Frio no Guichê': 'Sangre Fría en la Ventanilla',
  'O Faro': 'El Olfato',
  'Rotina': 'Rutina',
  'Sete Portas': 'Siete Puertas',

  /* ---- versos de los logros (solo aparecen cuando se obtienen) ---- */
  'Você fechou o primeiro expediente. Nada disso parecia grave ainda.':
    'Cerraste tu primer turno. Nada de eso parecía grave todavía.',
  'Chegou ao fim com o cadastro limpo e sem um suborno. O Ministério gosta do senhor. Pense nisso.':
    'Llegaste al final con el historial limpio y sin un solo soborno. Al Ministerio le agradas. Piénsalo.',
  'Atravessou a fronteira sem um papel sequer, depois de 48 dias exigindo todos.':
    'Cruzaste la frontera sin un solo papel, después de 48 días exigiéndolos todos.',
  'Seis atravessaram. A cidade ficou em paz. Ninguém mais grita à noite.':
    'Seis cruzaron. La ciudad quedó en paz. Nadie más grita por la noche.',
  'Chegou ao dia 48 e abriu a porta do banheiro.':
    'Llegaste al día 48 y abriste la puerta del baño.',
  'Sobreviveu duas vezes ao que entra sem constar do livro. Carimbe qualquer coisa. E deixe ir.':
    'Sobreviviste dos veces a lo que entra sin constar en el libro. Sella cualquier cosa. Y déjalo ir.',
  'Você olhou de perto. Ele também.':
    'Miraste de cerca. Él también.',
  'Os quatro chegaram vivos ao dia 48. Vessa, Tomi, Dario e sua mãe.':
    'Los cuatro llegaron vivos al día 48. Vessa, Tomi, Dario y tu madre.',
  '48 dias sem aceitar um único envelope por baixo do vidro.':
    '48 días sin aceptar un solo sobre bajo el vidrio.',
  'Ninguém dormiu com frio nesta casa.':
    'Nadie durmió con frío en esta casa.',
  'O Contador veio conferir a conta e voltou algemado.':
    'El Contador vino a revisar la cuenta y se fue esposado.',
  'O amigo do Tomi avisou. O amigo do Tomi acertou. O amigo do Tomi não existe.':
    'El amigo de Tomi avisó. El amigo de Tomi acertó. El amigo de Tomi no existe.',
  'Olhou no espelho e reconheceu o que estava lá.':
    'Se miró al espejo y reconoció lo que había ahí.',
  'Deteve ou abateu um agressor no guichê antes que ele agisse.':
    'Detuvo o abatió a un agresor en la ventanilla antes de que actuara.',
  'Oito Alternados identificados. Nenhum inocente detido no caminho.':
    'Ocho Alternados identificados. Ningún inocente detenido en el camino.',
  'Seis envelopes ou mais. Parou de contar antes do Ministério contar por você.':
    'Seis sobres o más. Dejaste de contar antes de que el Ministerio contara por ti.',
  'Uma menção, um nome, uma porta que não abriu mais.':
    'Una mención, un nombre, una puerta que no volvió a abrirse.',
  ...
  'DATA': 'FECHA',
  'POSTO': 'PUESTO',
  /* ---- archivo de libretas (8 guardados) + muerte que reabre el día ---- */
  'ARQUIVO DE CADERNETAS — POSTO Nº 7': 'ARCHIVO DE LIBRETAS — PUESTO Nº 7',
  'CADERNETAS': 'LIBRETAS',
  'CADERNETAS — SALVAR / CARREGAR': 'LIBRETAS — GUARDAR / CARGAR',
  'CADERNETA DE SERVIÇO': 'LIBRETA DE SERVICIO',
  '— em branco —': '— en blanco —',
  'Capa sem etiqueta. Nenhum expediente consta.': 'Tapa sin etiqueta. Ninguna jornada consta.',
  'ARQUIVADA': 'ARCHIVADA',
  'GRAVAR': 'GUARDAR',
  'REGRAVAR': 'SOBRESCRIBIR',
  'ABRIR': 'ABRIR',
  'VOLTAR': 'VOLVER',
  'DESCARTAR': 'DESTRUIR',
  'Descartar': 'Destruir',
  'REGIME': 'RÉGIMEN',
  'TURNO': 'TURNO',
  'gravada em ': 'guardada el ',
  'O expediente em curso é o <b>DIA</b> ': 'La jornada en curso es el <b>DÍA</b> ',
  '. Grave numa caderneta livre — ou por cima de uma velha, que é como o Ministério faz.':
    '. Guárdela en una libreta libre — o encima de una vieja, que es como lo hace el Ministerio.',
  'Oito cadernetas cabem nesta prateleira. O turno também se grava sozinho todo fim de expediente, e a morte devolve o inspetor à manhã do mesmo dia.':
    'Ocho libretas caben en este estante. El turno también se guarda solo al final de cada jornada, y la muerte devuelve al inspector a la mañana del mismo día.',
  'REGRAVAR A CADERNETA ': 'SOBRESCRIBIR LA LIBRETA ',
  'ABRIR A CADERNETA ': 'ABRIR LA LIBRETA ',
  'DESCARTAR A CADERNETA ': 'DESTRUIR LA LIBRETA ',
  'O expediente arquivado nesta caderneta será substituído pelo atual. Não há segunda via.':
    'La jornada archivada en esta libreta será sustituida por la actual. No hay segunda copia.',
  'O expediente em curso é abandonado e o inspetor volta à manhã registrada nesta caderneta.':
    'La jornada en curso se abandona y el inspector vuelve a la mañana registrada en esta libreta.',
  'A caderneta é destruída. O que estava escrito nela deixa de ter existido — é assim que este país arquiva.':
    'La libreta se destruye. Lo que estaba escrito en ella deja de haber existido — así archiva este país.',
  'DEIXAR COMO ESTÁ': 'DEJARLA ASÍ',
  'ARQUIVO CHEIO': 'ARCHIVO LLENO',
  'Não há espaço no arquivo desta máquina para mais uma caderneta. Descarte uma antiga e tente de novo.':
    'No hay espacio en el archivo de esta máquina para otra libreta. Destruya una vieja e inténtelo de nuevo.',
  'ENTENDIDO': 'ENTENDIDO',
  'REABRIR O DIA': 'REABRIR EL DÍA',
  '08:00': '08:00',
  '"Escolha, então. Obrigado pela franqueza."': '"Elija, entonces. Gracias por la franqueza."',
  'FINAL — A CONTA FECHADA': 'FINAL — LA CUENTA CERRADA',
  'A Conta Fechada': 'La Cuenta Cerrada',
  /* ---- cuaderno de la casa / cautelas ---- */
  'MORADORES DO APARTAMENTO': 'RESIDENTES DEL APARTAMENTO',
  'CONTAS DO DIA': 'CUENTAS DEL DÍA',
  'CAUTELAS DE RACIONAMENTO': 'CUPONES DE RACIONAMIENTO',
  'CAUTELA': 'CUPÓN',
  'Saldo em caixa': 'Saldo en caja',
  'Aluguel (descontado à noite)': 'Alquiler (descontado de noche)',
  'Sobra depois da noite': 'Queda tras la noche',
  'Comida para a família': 'Comida para la familia',
  'Carvão para o fogão': 'Carbón para la estufa',
  'Remédio para': 'Medicina para',
  'Calibração do detector (sem recibo)': 'Calibración del detector (sin recibo)',
  'bem': 'bien',
  'com fome': 'con hambre',
  'DOENTE': 'ENFERMO',
  'falecido(a)': 'fallecido(a)',
  'esposa': 'esposa',
  'SEM MATERIAL': 'SIN MATERIAL',
