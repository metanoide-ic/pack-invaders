...
const I18N_EN = {
  ...
  'Você olha para o vidro. O vidro sempre refletiu — hoje não é diferente, é só a primeira vez que você presta atenção nisso durante o expediente.\n\nOs documentos do outro lado são os seus: nome, foto, 48 assinaturas de turno, nenhuma delas perfeitamente igual à anterior. Ninguém nunca reparou. Você também não reparava nos outros.\n\nA mão pega o carimbo. É o mesmo gesto de sempre — nem apressado, nem hesitante, só conhecido, do jeito que um músculo conhece um movimento depois de repeti-lo mil vezes sem pensar.\n\nAPROVADO. A tinta seca. Do outro lado do vidro, alguém com o seu rosto guarda os documentos, levanta, e sai andando na direção de uma vida que talvez seja a sua. Você fica sentado mais um instante, sem saber ao certo qual dos dois ficou com o lugar de verdade.':
    "You look at the glass. The glass always reflected — today isn't different, it's just the first time you pay attention to that during a shift.\n\nThe documents on the other side are yours: name, photo, 48 shift signatures, none of them perfectly matching the last. No one ever noticed. You never noticed it in others either.\n\nYour hand picks up the stamp. It's the same gesture as always — neither rushed nor hesitant, just familiar, the way a muscle knows a movement after repeating it a thousand times without thinking.\n\nAPPROVED. The ink dries. On the other side of the glass, someone with your face gathers the documents, stands, and walks off toward a life that might be yours. You stay seated a moment longer, not quite sure which of the two ended up with the real place.",

  'FINAL — O CARIMBO NÃO HESITOU': "ENDING — THE STAMP DIDN'T HESITATE",
  'Você olha para o vidro, para o seu próprio rosto do outro lado, e aprova sem pausa. É o mesmo gesto de sempre: rápido, seco, definitivo.\n\nO problema é que você lembra dos outros gestos, os de antes. Várias pessoas inocentes saíram do seu guichê algemadas porque era mais fácil detê-las do que continuar duvidando. Você chamou isso de rigor, na época. Chamou isso de fazer o trabalho direito.\n\nO reflexo aceita o carimbo sem reclamar. Claro que aceita — ele é você, e você nunca recusou nada de si mesmo antes.\n\nAPROVADO. A tinta seca. Do outro lado do vidro, alguém com o seu rosto guarda os documentos e sai andando, como se nada tivesse pesado, porque para ele — para você — nunca pesou o suficiente.':
    "You look at the glass, at your own face on the other side, and approve without a pause. It's the same gesture as always: fast, dry, final.\n\nThe trouble is you remember the other gestures, the earlier ones. Several innocent people left your window in handcuffs because it was easier to detain them than to keep doubting. You called that rigor, back then. You called it doing the job right.\n\nThe reflection accepts the stamp without complaint. Of course it does — it's you, and you've never refused yourself anything before.\n\nAPPROVED. The ink dries. On the other side of the glass, someone with your face gathers the documents and walks off, as if none of it had weighed anything, because for him — for you — it never weighed enough.",

  'FINAL — O PREÇO DO PRÓPRIO CARIMBO': 'ENDING — THE PRICE OF YOUR OWN STAMP',
  'Você desliza os seus documentos pela bandeja e, por hábito, procura o envelope. Não tem envelope. É você do outro lado do vidro; você não vai subornar a si mesmo, ainda que uma parte sua ache graça na ideia.\n\nFoi fácil, no fim das contas. Um envelope aqui, outro ali, ninguém contando alto o bastante para ouvir. O dinheiro pagou o remédio, o aquecimento, um mês de aluguel adiantado. Também pagou, sem que ninguém assinasse nada, o direito de algumas pessoas erradas atravessarem a fronteira.\n\nO reflexo espera, paciente, com a mesma cara que você tem quando finge não fazer contas.\n\nVocê aprova. Claro que aprova — o seu próprio carimbo, pelo menos esse, sempre esteve à venda para você mesmo, de graça.':
    "You slide your documents across the tray and, out of habit, look for the envelope. There's no envelope. It's you on the other side of the glass; you're not going to bribe yourself, though part of you finds the idea funny.\n\nIt was easy, in the end. An envelope here, another there, no one ever counting loud enough to be heard. The money paid for the medicine, the heating, a month's rent in advance. It also paid, without anyone signing anything, for the right of a few wrong people to cross the border.\n\nThe reflection waits, patient, wearing the same face you wear when you pretend not to be doing the math.\n\nYou approve. Of course you approve — your own stamp, at least, has always been for sale to yourself, free of charge.",

  'FINAL — O PORTÃO DE FERRO': 'ENDING — THE IRON GATE',
  'Você rejeitou mais do que aprovou. No fim, rejeitar virou o padrão, e aprovar, a exceção que precisava se justificar.\n\nHá pessoas na fronteira de Osteria, hoje, que nunca vão saber que passaram pelo seu guichê e voltaram para onde vieram por causa de uma vírgula errada, um selo desbotado, um segundo de dúvida que você decidiu não arriscar. Algumas delas, você sabe, não tinham para onde voltar.\n\nO reflexo no vidro é implacável do mesmo jeito. Você olha para ele, reconhece o gesto — o carimbo vermelho decidido antes mesmo de ler até o fim — e aprova a si mesmo sem hesitar, porque essa é a única coisa que você sempre aprova sem hesitar: o próprio rigor.\n\nO portão fica fechado para quase todo mundo. Para você, no fim, ele sempre esteve aberto.':
    "You rejected more than you approved. In the end, rejecting became the default, and approving the exception that had to justify itself.\n\nThere are people at Osteria's border, today, who will never know they passed through your window and turned back because of a misplaced comma, a faded seal, a second of doubt you decided not to risk. Some of them, you know, had nowhere to turn back to.\n\nThe reflection in the glass is just as implacable. You look at it, recognize the gesture — the red stamp decided before it even finished reading — and approve yourself without hesitation, because that's the one thing you always approve without hesitation: your own severity.\n\nThe gate stays closed for almost everyone. For you, in the end, it was always open.",

  'FINAL — A MÃO QUE NÃO TREMEU DO JEITO ERRADO': "ENDING — THE HAND THAT DIDN'T SHAKE THE WRONG WAY",
  'Nenhum inocente saiu do seu guichê algemado. Nem um, em 48 dias. Isso não está em nenhum boletim do Ministério — não é o tipo de número que eles publicam — mas você sabe, e é seu.\n\nAjudou quem pôde ajudar, quando havia como ajudar sem que ninguém visse. Um bilhete guardado em vez de queimado. Um nome que você não perguntou de novo na segunda vez que apareceu.\n\nO reflexo no vidro aprova a si mesmo, e pela primeira vez em 48 dias isso não parece um gesto vazio. Parece, quase, merecido.\n\nVocê não salvou o país. Não salvou nem o posto. Salvou algumas pessoas específicas, com nome, que você nunca soube se eram humanas ou não — e decidiu, no fim, que a pergunta importava menos do que a resposta que você deu.':
    "No innocent left your window in handcuffs. Not one, in 48 days. It's not in any Ministry bulletin — it's not the kind of number they publish — but you know it, and it's yours.\n\nYou helped who you could help, when there was a way to help without anyone seeing. A note kept instead of burned. A name you didn't ask about again the second time it came up.\n\nThe reflection in the glass approves itself, and for the first time in 48 days that doesn't feel like an empty gesture. It feels, almost, earned.\n\nYou didn't save the country. Didn't even save the post. You saved a few specific people, with names, who you never found out were human or not — and decided, in the end, that the question mattered less than the answer you gave.",

  'FINAL — A MÁQUINA PERFEITA': 'ENDING — THE PERFECT MACHINE',
  'Nenhum erro registrado. Trinta e cinco decisões corretas, ou mais — o número exato nem importa mais, porque a partir de um certo ponto "perfeito" deixa de ser contável e vira só um estado permanente.\n\nOs colegas param de te chamar pelo nome nos últimos dias. Chamam de "o modelo", em voz baixa, meio elogio, meio aviso. Ninguém acerta 48 dias seguidos sendo humano o tempo inteiro.\n\nO reflexo no vidro aprova, e a mão não treme, porque a mão nunca tremeu — nem uma vez, em 48 dias, mesmo quando devia.\n\nVocê saiu do posto sem uma única marca no registro. Não sabe mais dizer se isso prova que fez tudo certo, ou só que parou de sentir a diferença entre certo e errado faz tempo.':
    'No error on record. Thirty-five correct decisions, or more — the exact number doesn\'t matter anymore, because past a certain point "perfect" stops being countable and just becomes a permanent state.\n\nYour colleagues stop calling you by name in the last few days. They call you "the model," under their breath, half compliment, half warning. No one gets 48 days right in a row while staying human the whole time.\n\nThe reflection in the glass approves, and the hand doesn\'t shake, because the hand never shook — not once, in 48 days, even when it should have.\n\nYou left the post without a single mark on your record. You can no longer tell whether that proves you did everything right, or just that you stopped feeling the difference between right and wrong a while ago.',

  'FINAL — A MESA COM UM LUGAR A MENOS': 'ENDING — THE TABLE WITH ONE PLACE MISSING',
  'A casa não ficou vazia. Ficou incompleta, o que de algum jeito dói mais: a rotina continua, o jantar é servido, só que sempre com um prato de menos que ninguém tira da pilha.\n\nOs que restaram não falam do assunto. Falam ao redor dele, com uma delicadeza que vocês nunca precisaram ter uns com os outros antes.\n\nVocê carimbou documentos por 48 dias tentando decidir quem entra e quem fica de fora. Não conseguiu decidir a única coisa que importava de verdade: quem, na sua própria casa, sobrevive ao inverno.\n\nO posto reabre amanhã, com ou sem você. A mesa em casa também.':
    "The house didn't end up empty. It ended up incomplete, which somehow hurts more: the routine goes on, dinner gets served, just always one plate short of the stack no one puts away.\n\nThe ones who stayed don't talk about it. They talk around it, with a delicacy none of you ever needed with each other before.\n\nYou stamped documents for 48 days trying to decide who gets in and who's left out. You never managed to decide the one thing that actually mattered: who, in your own house, survives the winter.\n\nThe post reopens tomorrow, with or without you. So does the table at home.",
  ...
  'O relatório do Ministério não sabe o que você fez. Sabe os números, e os números não perdoam.\n\nVárias pessoas inocentes passaram pelo seu guichê e saíram detidas. Vários Alternados, ao mesmo tempo, passaram pelo mesmo guichê e saíram livres, sem que você desconfiasse de nada.\n\nNão há uma palavra oficial para isso. Você inventou uma, sozinho, numa madrugada de insônia: errar para os dois lados. Bateu na porta errada da paranoia e na porta errada da negligência, na mesma semana, com o mesmo carimbo.\n\nDia 48. Você ainda não sabe se prendeu gente demais ou gente de menos. As duas coisas são verdadeiras ao mesmo tempo, e essa é a única certeza que sobrou.':
    "The Ministry's report doesn't know what you did. It knows the numbers, and the numbers don't forgive.\n\nSeveral innocent people passed through your window and left detained. Several Alternates, at the same time, passed through the same window and left free, without you suspecting a thing.\n\nThere's no official word for that. You invented one, alone, on a sleepless night: erring in both directions at once. You hit the wrong door of paranoia and the wrong door of negligence, in the same week, with the same stamp.\n\nDay 48. You still don't know whether you detained too many people or too few. Both are true at the same time, and that's the only certainty left.",
...
const I18N_ES = {
  ...
  'Você olha para o vidro. O vidro sempre refletiu — hoje não é diferente, é só a primeira vez que você presta atenção nisso durante o expediente.\n\nOs documentos do outro lado são os seus: nome, foto, 48 assinaturas de turno, nenhuma delas perfeitamente igual à anterior. Ninguém nunca reparou. Você também não reparava nos outros.\n\nA mão pega o carimbo. É o mesmo gesto de sempre — nem apressado, nem hesitante, só conhecido, do jeito que um músculo conhece um movimento depois de repeti-lo mil vezes sem pensar.\n\nAPROVADO. A tinta seca. Do outro lado do vidro, alguém com o seu rosto guarda os documentos, levanta, e sai andando na direção de uma vida que talvez seja a sua. Você fica sentado mais um instante, sem saber ao certo qual dos dois ficou com o lugar de verdade.':
    'Miras el vidrio. El vidrio siempre reflejó — hoy no es diferente, es solo la primera vez que le prestas atención durante el turno.\n\nLos documentos del otro lado son los tuyos: nombre, foto, 48 firmas de turno, ninguna perfectamente igual a la anterior. Nadie lo notó nunca. Tú tampoco lo notabas en los demás.\n\nLa mano toma el sello. Es el mismo gesto de siempre — ni apresurado ni dudoso, solo conocido, como un músculo que conoce un movimiento después de repetirlo mil veces sin pensar.\n\nAPROBADO. La tinta se seca. Del otro lado del vidrio, alguien con tu rostro guarda los documentos, se levanta, y se aleja hacia una vida que tal vez sea la tuya. Te quedas sentado un instante más, sin saber bien cuál de los dos se quedó con el lugar de verdad.',

  'FINAL — O CARIMBO NÃO HESITOU': 'FINAL — EL SELLO NO DUDÓ',
  'Você olha para o vidro, para o seu próprio rosto do outro lado, e aprova sem pausa. É o mesmo gesto de sempre: rápido, seco, definitivo.\n\nO problema é que você lembra dos outros gestos, os de antes. Várias pessoas inocentes saíram do seu guichê algemadas porque era mais fácil detê-las do que continuar duvidando. Você chamou isso de rigor, na época. Chamou isso de fazer o trabalho direito.\n\nO reflexo aceita o carimbo sem reclamar. Claro que aceita — ele é você, e você nunca recusou nada de si mesmo antes.\n\nAPROVADO. A tinta seca. Do outro lado do vidro, alguém com o seu rosto guarda os documentos e sai andando, como se nada tivesse pesado, porque para ele — para você — nunca pesou o suficiente.':
    'Miras el vidrio, tu propio rostro del otro lado, y apruebas sin pausa. Es el mismo gesto de siempre: rápido, seco, definitivo.\n\nEl problema es que recuerdas los otros gestos, los de antes. Varias personas inocentes salieron de tu ventanilla esposadas porque era más fácil detenerlas que seguir dudando. Lo llamaste rigor, en ese momento. Lo llamaste hacer bien el trabajo.\n\nEl reflejo acepta el sello sin quejarse. Claro que acepta — es tú, y nunca te has negado nada a ti mismo antes.\n\nAPROBADO. La tinta se seca. Del otro lado del vidrio, alguien con tu rostro guarda los documentos y se aleja, como si nada hubiera pesado, porque para él — para ti — nunca pesó lo suficiente.',

  'FINAL — O PREÇO DO PRÓPRIO CARIMBO': 'FINAL — EL PRECIO DEL PROPIO SELLO',
  'Você desliza os seus documentos pela bandeja e, por hábito, procura o envelope. Não tem envelope. É você do outro lado do vidro; você não vai subornar a si mesmo, ainda que uma parte sua ache graça na ideia.\n\nFoi fácil, no fim das contas. Um envelope aqui, outro ali, ninguém contando alto o bastante para ouvir. O dinheiro pagou o remédio, o aquecimento, um mês de aluguel adiantado. Também pagou, sem que ninguém assinasse nada, o direito de algumas pessoas erradas atravessarem a fronteira.\n\nO reflexo espera, paciente, com a mesma cara que você tem quando finge não fazer contas.\n\nVocê aprova. Claro que aprova — o seu próprio carimbo, pelo menos esse, sempre esteve à venda para você mesmo, de graça.':
    'Deslizas tus documentos por la bandeja y, por costumbre, buscas el sobre. No hay sobre. Eres tú del otro lado del vidrio; no vas a sobornarte a ti mismo, aunque una parte tuya le encuentra la gracia a la idea.\n\nFue fácil, al final. Un sobre aquí, otro allá, nadie contando lo bastante alto para que se oyera. El dinero pagó el remedio, la calefacción, un mes de alquiler adelantado. También pagó, sin que nadie firmara nada, el derecho de algunas personas equivocadas a cruzar la frontera.\n\nEl reflejo espera, paciente, con la misma cara que pones cuando finges no hacer cuentas.\n\nApruebas. Claro que apruebas — tu propio sello, al menos ese, siempre estuvo en venta para ti mismo, gratis.',

  'FINAL — O PORTÃO DE FERRO': 'FINAL — EL PORTÓN DE HIERRO',
  'Você rejeitou mais do que aprovou. No fim, rejeitar virou o padrão, e aprovar, a exceção que precisava se justificar.\n\nHá pessoas na fronteira de Osteria, hoje, que nunca vão saber que passaram pelo seu guichê e voltaram para onde vieram por causa de uma vírgula errada, um selo desbotado, um segundo de dúvida que você decidiu não arriscar. Algumas delas, você sabe, não tinham para onde voltar.\n\nO reflexo no vidro é implacável do mesmo jeito. Você olha para ele, reconhece o gesto — o carimbo vermelho decidido antes mesmo de ler até o fim — e aprova a si mesmo sem hesitar, porque essa é a única coisa que você sempre aprova sem hesitar: o próprio rigor.\n\nO portão fica fechado para quase todo mundo. Para você, no fim, ele sempre esteve aberto.':
    'Rechazaste más de lo que aprobaste. Al final, rechazar se volvió la norma, y aprobar, la excepción que necesitaba justificarse.\n\nHay personas en la frontera de Osteria, hoy, que nunca sabrán que pasaron por tu ventanilla y dieron media vuelta por una coma mal puesta, un sello desteñido, un segundo de duda que decidiste no arriesgar. Algunas de ellas, lo sabes, no tenían adónde volver.\n\nEl reflejo en el vidrio es igual de implacable. Lo miras, reconoces el gesto — el sello rojo decidido antes incluso de terminar de leer — y te apruebas a ti mismo sin dudar, porque eso es lo único que siempre apruebas sin dudar: tu propio rigor.\n\nEl portón queda cerrado para casi todos. Para ti, al final, siempre estuvo abierto.',

  'FINAL — A MÃO QUE NÃO TREMEU DO JEITO ERRADO': 'FINAL — LA MANO QUE NO TEMBLÓ DEL MODO EQUIVOCADO',
  'Nenhum inocente saiu do seu guichê algemado. Nem um, em 48 dias. Isso não está em nenhum boletim do Ministério — não é o tipo de número que eles publicam — mas você sabe, e é seu.\n\nAjudou quem pôde ajudar, quando havia como ajudar sem que ninguém visse. Um bilhete guardado em vez de queimado. Um nome que você não perguntou de novo na segunda vez que apareceu.\n\nO reflexo no vidro aprova a si mesmo, e pela primeira vez em 48 dias isso não parece um gesto vazio. Parece, quase, merecido.\n\nVocê não salvou o país. Não salvou nem o posto. Salvou algumas pessoas específicas, com nome, que você nunca soube se eram humanas ou não — e decidiu, no fim, que a pergunta importava menos do que a resposta que você deu.':
    'Ningún inocente salió de tu ventanilla esposado. Ni uno, en 48 días. Eso no aparece en ningún boletín del Ministerio — no es el tipo de número que publican — pero tú lo sabes, y es tuyo.\n\nAyudaste a quien pudiste ayudar, cuando hubo forma de ayudar sin que nadie viera. Una nota guardada en vez de quemada. Un nombre que no volviste a preguntar la segunda vez que apareció.\n\nEl reflejo en el vidrio se aprueba a sí mismo, y por primera vez en 48 días eso no parece un gesto vacío. Parece, casi, merecido.\n\nNo salvaste al país. Ni siquiera salvaste el puesto. Salvaste a algunas personas concretas, con nombre, de las que nunca supiste si eran humanas o no — y decidiste, al final, que la pregunta importaba menos que la respuesta que diste.',

  'FINAL — A MÁQUINA PERFEITA': 'FINAL — LA MÁQUINA PERFECTA',
  'Nenhum erro registrado. Trinta e cinco decisões corretas, ou mais — o número exato nem importa mais, porque a partir de um certo ponto "perfeito" deixa de ser contável e vira só um estado permanente.\n\nOs colegas param de te chamar pelo nome nos últimos dias. Chamam de "o modelo", em voz baixa, meio elogio, meio aviso. Ninguém acerta 48 dias seguidos sendo humano o tempo inteiro.\n\nO reflexo no vidro aprova, e a mão não treme, porque a mão nunca tremeu — nem uma vez, em 48 dias, mesmo quando devia.\n\nVocê saiu do posto sem uma única marca no registro. Não sabe mais dizer se isso prova que fez tudo certo, ou só que parou de sentir a diferença entre certo e errado faz tempo.':
    'Ningún error registrado. Treinta y cinco decisiones correctas, o más — el número exacto ya ni importa, porque a partir de cierto punto "perfecto" deja de ser contable y se vuelve solo un estado permanente.\n\nTus colegas dejan de llamarte por tu nombre en los últimos días. Te dicen "el modelo", en voz baja, mitad elogio, mitad advertencia. Nadie acierta 48 días seguidos siendo humano todo el tiempo.\n\nEl reflejo en el vidrio aprueba, y la mano no tiembla, porque la mano nunca tembló — ni una sola vez, en 48 días, incluso cuando debía.\n\nSaliste del puesto sin una sola marca en tu historial. Ya no sabes decir si eso prueba que hiciste todo bien, o solo que dejaste de sentir la diferencia entre lo correcto y lo incorrecto hace tiempo.',

  'FINAL — A MESA COM UM LUGAR A MENOS': 'FINAL — LA MESA CON UN LUGAR DE MENOS',
  'A casa não ficou vazia. Ficou incompleta, o que de algum jeito dói mais: a rotina continua, o jantar é servido, só que sempre com um prato de menos que ninguém tira da pilha.\n\nOs que restaram não falam do assunto. Falam ao redor dele, com uma delicadeza que vocês nunca precisaram ter uns com os outros antes.\n\nVocê carimbou documentos por 48 dias tentando decidir quem entra e quem fica de fora. Não conseguiu decidir a única coisa que importava de verdade: quem, na sua própria casa, sobrevive ao inverno.\n\nO posto reabre amanhã, com ou sem você. A mesa em casa também.':
    'La casa no quedó vacía. Quedó incompleta, lo que de algún modo duele más: la rutina continúa, la cena se sirve, solo que siempre falta un plato de la pila que nadie guarda.\n\nLos que quedaron no hablan del tema. Hablan alrededor de él, con una delicadeza que nunca antes necesitaron tener entre ustedes.\n\nSellaste documentos durante 48 días tratando de decidir quién entra y quién se queda afuera. No lograste decidir lo único que de verdad importaba: quién, en tu propia casa, sobrevive al invierno.\n\nEl puesto reabre mañana, contigo o sin ti. La mesa en casa también.',
  ...
  'O relatório do Ministério não sabe o que você fez. Sabe os números, e os números não perdoam.\n\nVárias pessoas inocentes passaram pelo seu guichê e saíram detidas. Vários Alternados, ao mesmo tempo, passaram pelo mesmo guichê e saíram livres, sem que você desconfiasse de nada.\n\nNão há uma palavra oficial para isso. Você inventou uma, sozinho, numa madrugada de insônia: errar para os dois lados. Bateu na porta errada da paranoia e na porta errada da negligência, na mesma semana, com o mesmo carimbo.\n\nDia 48. Você ainda não sabe se prendeu gente demais ou gente de menos. As duas coisas são verdadeiras ao mesmo tempo, e essa é a única certeza que sobrou.':
    'El informe del Ministerio no sabe lo que hiciste. Sabe los números, y los números no perdonan.\n\nVarias personas inocentes pasaron por tu ventanilla y salieron detenidas. Varios Alternados, al mismo tiempo, pasaron por la misma ventanilla y salieron libres, sin que sospecharas nada.\n\nNo hay una palabra oficial para eso. Inventaste una, sola, en una madrugada de insomnio: equivocarse en los dos sentidos. Golpeaste la puerta equivocada de la paranoia y la puerta equivocada de la negligencia, en la misma semana, con el mismo sello.\n\nDía 48. Todavía no sabes si detuviste a demasiada gente o a muy poca. Las dos cosas son verdad al mismo tiempo, y esa es la única certeza que queda.',
